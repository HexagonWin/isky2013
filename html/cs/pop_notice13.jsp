<!-- m4th snowbin 070430 : 네트워크 점검으로 인한 셀프업그레이드 S/W 다운로드 제한 팝업 (긴급 요청으로 인한 팝업) -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice13.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070430", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	...
	<div style="margin:15 0 0 6">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt13.gif"></div>
