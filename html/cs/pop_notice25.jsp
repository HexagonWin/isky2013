<!-- m4th MSD 070903 *조형빈 New 액서사리 배송지연 안내 팝업 -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice25.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070903", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	<div class="tit4"><!-- 팝업 타이틀 //--><img src="http://www.isky.co.kr/source/img/global/popup/t_notice25.gif"></div>

	<div style="margin:15 0 0 10">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt25.gif"></div>
