<!-- m4th MSD 070927 *조형빈 New / ok캐쉬백이 수리비용을 돌려드립니다. 팝업 -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice30.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070927", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<tr valign="top" height="100%"><td><!-- td style="padding:13 11"-->
<!-- 팝업 내용 //-->
	<!-- div class="tit4" --><!-- 팝업 타이틀 //--><!-- img src="http://www.isky.co.kr/source/img/global/popup/t_notice28.gif"></div -->

	<!-- div style="margin:15 0 0 10" -->
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt30.gif"><!-- usemap="#pop_notice_txt26" --></div>
