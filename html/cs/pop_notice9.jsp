...
<input type="hidden" name="top_url" value="/html/cs/pop_notice9.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070410_cs2", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	...
	<div style="margin:15 0 0 6">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt07.gif"></div>
