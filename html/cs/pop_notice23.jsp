<!-- m4th MSD 070810 *조형빈 New 액세서리몰 계좌결제만 가능 알림 팝업 -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice23.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070810", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	<div class="tit4"><!-- 팝업 타이틀 //--><img src="http://www.isky.co.kr/source/img/global/popup/t_notice23.gif"></div>

	<div style="margin:15 0 0 10">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt23.gif"></div>
