...
<input type="hidden" name="top_url" value="/html/cs/pop_notice.jsp">
...
<script language="JavaScript">
	...
	setCookie( "notice", "done2" , 2); //하룻동안 열지 않음
	self.close(); 
    }
...
function detail_go() {
	...
	opener.location.href = "http://www.isky.co.kr/html/cs/notice.jsp";
	self.close(); 
	}
...
<!-- 팝업 내용 //-->
	...
	<div style="margin:25 0 0 13"><img src="http://www.isky.co.kr/source/img/global/popup/notice_txt01.gif"></div>
