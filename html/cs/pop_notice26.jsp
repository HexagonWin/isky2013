<!-- m4th MSD 070917 *조형빈 New IM-s230 모델 최신 s/w 업그레이드 안내 팝업 -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice26.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070917", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	<div class="tit4"><!-- 팝업 타이틀 //--><img src="http://www.isky.co.kr/source/img/global/popup/t_notice26.gif"></div>

	<div style="margin:15 0 0 10">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt26.gif" usemap="#pop_notice_txt26"></div>
