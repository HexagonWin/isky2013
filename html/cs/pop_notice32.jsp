<!-- m4th MSD 070917 *조형빈 New / 용산서비스센터 임시휴무 팝업 -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice32.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20071010", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	<div class="tit4"><!-- 팝업 타이틀 //--><img src="http://www.isky.co.kr/source/img/global/popup/t_notice32.gif"></div>

	<div style="margin:15 0 0 10">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt32.gif" usemap="#pop_notice_txt31"></div>
