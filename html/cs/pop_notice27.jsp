<!-- m4th MSD 070918 *조형빈 New / 태풍-수해로 어려운 제주도민 팝업 -->
...
<input type="hidden" name="top_url" value="/html/cs/pop_notice27.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070918", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	<div class="tit4"><!-- 팝업 타이틀 //--><img src="http://www.isky.co.kr/source/img/global/popup/t_notice27.gif"></div>

	<div style="margin:15 0 0 10">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt27.gif"><!-- usemap="#pop_notice_txt26" --></div>
