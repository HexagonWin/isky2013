...
<input type="hidden" name="top_url" value="/html/cs/pop_notice14.jsp">
...
<script language="JavaScript">
	...
	setCookie( "popup20070425", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
...
<!-- 팝업 내용 //-->
	...
	<div style="margin:15 0 0 6">
		<div><img src="http://www.isky.co.kr/source/img/global/popup/pop_notice_txt14.gif"></div>
