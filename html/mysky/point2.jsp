...
<input type="hidden" name="top_url" value="/html/mysky/point2.jsp">
...
<body class="iframe_t">
	...
	<!-- 탭 -->
	<div class="tab m_b20 m_t20"><a href="point1.jsp"><img src="http://www.isky.co.kr/source/img/mysky/point_tab01.gif" width="285"></a><a href="point2.jsp"><img src="http://www.isky.co.kr/source/img/mysky/point_tab02_.gif" width="283"></a></div>

	<!-- 적립금 사용내역 조회 -->
	<h3 style="margin-top:0;"><img src="http://www.isky.co.kr/source/img/mysky/point_tss03.gif"></h3>
	...
	<tr height="22">
		...
		<th><img src="http://www.isky.co.kr/source/img/bbs/th_pointout2.gif"></th>
	</tr>
	<!-- 반복 * 7 , 마지막 라인은 class="dot" 제외 //-->
	
	</table>
	</form>

<script language="javascript">
change("2007","08","20",frmMain.sDD);
change("2007","08","27",frmMain.eDD);
