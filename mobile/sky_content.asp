...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=/mobile/sky_content.asp?&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0></iframe>
		...
		<embed src="http://file.isky.co.kr/flash/top_flash_final.swf?loginYN=N" width=728 height=169>
			...
			<!-- 우측 상단 플래쉬 메뉴 영역 END -->
				...
				<tr>
					...
					<DIV class="CONTENTS">
					<!-- 컨텐츠 BODY 역역 START -->
					<!-- path 영역 --><DIV class="LINEMAP"><a href='http://www.isky.co.kr/'>Home</a> &gt; <a href='http://www.isky.co.kr/mobile/Main.asp'>모바일</a> &gt; <a href='http://www.isky.co.kr/mobile/sky_content.asp'>스카이광고 모바일컨텐츠</a></DIV><!-- path 영역 -->


			<IMG SRC="http://file.isky.co.kr/images/mobile/sky_char_division_title.gif"><BR>



			<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" CLASS="BD2">
			<TR>
				<TD><IMG SRC="http://file.isky.co.kr/images/mobile/sky_char_division_title_txt.gif"></TD>
				<TD ALIGN="RIGHT"><IMG SRC="http://file.isky.co.kr/images/mobile/sky_bell_division_title_ill.gif"></TD>
			</TR>
			</TABLE>

					<IMG SRC="http://file.isky.co.kr/images/com/spacer.gif" WIDTH="1" HEIGHT="10"><BR>

				<iframe src="/mobile/bell/sky_bell_list.asp?original=2&category=207" frameborder="0" width="690" height="700" marginwidth="0" marginheight="0"  scrolling="no"></iframe>
				<br><br><br>
				<iframe src="/mobile/character/sky_char_list.asp?category=999&size=m&search_string=IM-S1" frameborder="0" width="690" height="700" marginwidth="0" marginheight="0" scrolling="no"></iframe>
