...
<HTML>
	...
	<Meta_Title value="고객지원 고객공지 내용"/>
	<Meta_From value="isky"/>
	<Meta_Path value="고객지원:고객공지"/>
	<form name="Form1" method="post" action="SvcNoticeView.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwxOTMyNjI0ODk0Ozs+" />
	...
	<tr>
		<td>
			<OBJECT id="navigation" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
				...
				<embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E1" width=222 height=475 />
			</OBJECT>
		</td>
	</tr>
	<tr>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSVC%2fsvcnotice%2fSvcNoticeView.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSVC%2fsvcnotice%2fSvcNoticeView.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
		...
		<DIV class="LINEMAP"><a href="/" class=gray>Home</a> &gt <a href="/Main.aspx" class=gray>고객지원</a>&nbsp;&gt;&nbsp;고객공지</DIV CLOSE="LINEMAP">

			<img src="http://file.isky.co.kr/images/svc/notice_title.gif" width="118" height="50"><BR>
			...
			<DIV ID="CONTENTS_SUB" STYLE="PADDING-TOP:25PX;">
				...
				<TR>
					<TD COLSPAN="6" CLASS="BBS_READ_TT"><span id="lblTitle"></span></TD>
				</TR>
				<TR HEIGHT="28" STYLE="PADDING-TOP:4PX;">
					<TD WIDTH="108" CLASS="BBS_READ_TAB2">번호</TD>
					<TD WIDTH="171" CLASS="BBS_READ_TAB"><span id="lblNumber"></span></TD>
					<TD WIDTH="108" CLASS="BBS_READ_TAB2">작성일</TD>
					<TD WIDTH="134" CLASS="BBS_READ_TAB"><span id="lblRegDate"></span></TD>
					<TD WIDTH="58" CLASS="BBS_READ_TAB2">조회</TD>
					<TD WIDTH="91" CLASS="BBS_READ_TAB"><span id="lblHitCnt"></span></TD>
				</TR>
				<TR><TD COLSPAN="6" BGCOLOR="#E7D2D2"></TD></TR>
				<TR HEIGHT="28" STYLE="PADDING-TOP:4PX;">
					<TD CLASS="BBS_READ_TAB2">첨부파일</TD>
					<TD CLASS="BBS_READ_TAB" COLSPAN="5">
						<DIV id="divAttList" style="DISPLAY: inline; HEIGHT: 15px WIDHT:200px"></DIV>
					</TD>
				</TR>
				<TR><TD COLSPAN="6" BGCOLOR="#E7D2D2"></TD></TR>
				</TABLE>
				<DIV class=BBS_READ_CON><span id="lblContent"></span></DIV>
				<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
				<TR><TD COLSPAN="2" HEIGHT="4" BGCOLOR="#E7D2D2"></TD></TR>
				</TABLE>
				...
				<TR>
					<TD ALIGN="RIGHT" HEIGHT="43" STYLE="PADDING-TOP:6PX;">
						<A HREF="SvcNoticeList.aspx?pPageNo=1"><IMG SRC="http://file.isky.co.kr/images/com/bbs_button_list.gif"></A>
					</TD>
				</TR>
				<TR><TD HEIGHT="1" BGCOLOR="#E7D2D2"></TD></TR>
				</TABLE>
				...
				<TR>
					<TD>
						<span id="NxtSibling"></span>
						<span id="PreSibling"></span>
					</TD>
				</TR>
				</TABLE>
