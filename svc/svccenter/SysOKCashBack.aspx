...
<HTML>
	<HEAD>
		...
		<style>.itemtd {
	BORDER-BOTTOM: #e7d2d2 1px solid
}
		</style>
	</HEAD>
	<body leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	<Meta_Title value="OK캐쉬백">
	<Meta_From value="isky">
	<Meta_Path value="Home:고객지원:서비스제도안내:OK캐쉬백">
		<form name="Form1" method="post" action="SysOKCashBack.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDw2MjA0MDc0NjQ7Oz4=" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fsvccenter%2fSysOKCashBack.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fsvccenter%2fSysOKCashBack.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
		...
		<DIV class="LINEMAP"><a href="/" class=gray>Home</a> &gt; <a href="../../Main.aspx" class=gray>고객지원</a> &gt; <a href="SvcCenterMain.aspx" class=gray>서비스센터</a> &gt; <a href="SysParts.aspx" class=gray>서비스제도안내</a> &gt; OK캐쉬백 사용안내</DIV CLOSE="LINEMAP">
			...
			<DIV class="CONTENTS_SUB">
				...
				<TR>
					...
					<TD ALIGN="RIGHT">
						<A HREF="SysExchange.aspx"><img src="http://file.isky.co.kr/images/svc/btn_exchange.gif" width="69" height="21"></A>
						<A HREF="SysParts.aspx"><img src="http://file.isky.co.kr/images/svc/btn_unitcost.gif" width="68" height="21"></A>						
						<img src="http://file.isky.co.kr/images/svc/btn_okcashback_on.gif" width="104" height="21">
					</TD>
				</TR>
				<TR><TD HEIGHT="10"></TD></TR>
				</TABLE>
				...
				<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
				<tr>
					<td style="padding:0 0 4 0"><img src="http://file.isky.co.kr/images/svc/svc_txt02.gif" width="81" height="15"></td>
				</tr>
				<TR><TD HEIGHT="3" bgcolor="DDDDDD"></TD></TR>
				<TR><TD HEIGHT="1" bgcolor="E6E6E6"></TD></TR>
				<tr>
					<td style="padding:7 0 20 0"><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6"> SKY 서비스센터에서 OK캐쉬백 서비스를 실시하고 있습니다.<br><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6"> 더욱 편리하고 다양한 서비스로 고객 여러분의 사랑에 보답하겠습니다.</td>
				</tr>
				</TABLE>
				
				<table CELLPADDING="0" CELLSPACING="0" WIDTH="100%" style="border:1 solid #DFDFDF">
					<tr>
						<td align="center">
							<table width="648" cellpadding="0" cellspacing="0">
								<tr>
									<td width="102"><IMG src="http://file.isky.co.kr/images/svc/service_img1.gif"></td>
									<td>SKY 서비스센터에서 소모품 구입 또는 휴대폰 수리시해당 비용의 1%를 OK캐쉬백 포인트로 <br>적립할 수 있습니다.<br>
									<a href="SvcCenterMain.aspx"><img src="http://file.isky.co.kr/images/svc/btn_info_servicecenter.gif" style="margin-top:5"></a></td>
								</tr>
								<tr><td colspan="3" height="1" bgcolor="DFDFDF"></td></tr>
								<tr>
									<td><IMG src="http://file.isky.co.kr/images/svc/service_img2.gif"></td>
									<td>SKY 서비스센터에서 유상 수리/ 구매하시는 비용을 OK캐쉬백으로 결재하실 수 있습니다.<br>
									(단, OK캐쉬백 포인트 5,000점 이상 보유 고객만 가능. 1점=1원)<br>
									<a href="SysParts.aspx"><img src="http://file.isky.co.kr/images/svc/btn_info_price.gif" style="margin-top:5"></a></td>
								</tr>
							</table>
						</td>
					</tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						<td align="right" style="padding-top:10">
							<a href="http://www.okcashback.co.kr" target="_blank"><img src="http://file.isky.co.kr/images/svc/btn_inquiry_okcashbag.gif"></a>
						</td>
					</tr>
				</table>
