...
<HTML>
	<HEAD>
		...
		<STYLE>
				...
				.TD1 { PADDING-RIGHT: 5px; PADDING-LEFT: 5px; COLOR: #56373a; PADDING-TOP: 4px; BACKGROUND-COLOR: #f5f0f1 }
				.TD2 { PADDING-LEFT: 10px; PADDING-TOP: 4px; BACKGROUND-COLOR: #ffffff }
				.TD3 { PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-TOP: 4px; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: center }
		</STYLE>
	</HEAD>
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<Meta_Title value="교환환불" />
		<Meta_From value="isky" />
		<Meta_Path value="Home:고객지원:서비스제도안내:교환환불" />
		<form name="Form1" method="post" action="SysExchange.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwxMjM1NjgzODYyOzs+" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fsvccenter%2fSysExchange.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fsvccenter%2fSysExchange.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
									...
									<td>
										<DIV class="CONTENTS">
											<DIV class="LINEMAP"><a href="/" class="gray">Home</a> &gt; <a href="../../Main.aspx" class="gray">
													고객지원</a> &gt; <a href="SvcCenterMain.aspx" class="gray">서비스센터</a> &gt; <a href="SysParts.aspx" class="gray">
													서비스제도안내</a> &gt; 교환/환불</DIV>
											...
											<DIV class="CONTENTS_SUB">
												<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
													...
													<TR>
														...
														<TD ALIGN="right">
															<img src="http://file.isky.co.kr/images/svc/btn_exchange_on.gif" width="69" height="21">
															<A HREF="SysParts.aspx"><img src="http://file.isky.co.kr/images/svc/btn_unitcost.gif" width="68" height="21"></A>															
															<A HREF="SysOKCashBack.aspx"><img src="http://file.isky.co.kr/images/svc/btn_okcashback.gif" width="104" height="21"></A>
														</TD>
													</TR>
													<TR>
														<TD HEIGHT="10"></TD>
												...
												<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
													<tr>
														<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:4px; PADDING-TOP:0px"><img src="http://file.isky.co.kr/images/svc/svc_txt_02.gif"></td>
													</tr>
													<TR>
													...
													<tr>
														<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:20px; PADDING-TOP:15px"><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT">
															SKY에서는 소비자 보호법이 정하는 소비자피해 보상규정에 따라 아래와 같이 제품에 대한 보증을 실시합니다.<br>
															<br><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT">
															보상여부 및 내용통보는 요구 일로부터 7일 이내에, 피해보상은 통보일로 부터 14일 이내에 해결해 드립니다.<br>
															<br><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT">
															일반제품을 영업용 용도로 사용 할 경우 보증기간은 반으로 단축 적용됩니다.<br>
															<br><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT">
															구입후 제품 보증기간 이내에 제품이 고장 날 경우에만 무상 서비스를 받을 수 있습니다.<br>
															&nbsp; [제품보증기간] 단말기 및 액세서리(충전기, 스테레오이어마이크 등) : 구입 후 1년, 배터리 : 구입 후 6개월<br>
															 <br><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT"> 
															  SK텔레콤 데이터 서비스에서 다운 받은 유료 컨텐츠가 아니거나, 당사가 제공하지 않는 프로그램을 사용하여<br>
															  &nbsp;자체 제작한 파일 또는 임의의 사용자가 배포한 파일을 휴대폰으로 전송하여 사용할 경우 기능상 불량에 대해서는<br>
															  &nbsp;당사에서 책임지지 않습니다.</td>
													</tr>
												</TABLE>
												<table CELLPADDING="0" CELLSPACING="1" WIDTH="100%" BGCOLOR="#e7d2d2">
													<tr class="tab">
														<td height="58" colspan="3" rowspan="2"><img src="http://file.isky.co.kr/images/svc/svc_txt_03.gif"></td>
														<td colspan="2"><img src="http://file.isky.co.kr/images/svc/svc_txt_04.gif"></td>
													</tr>
													<tr class="tab">
														<td><img src="http://file.isky.co.kr/images/svc/svc_txt_05.gif"></td>
														<td><img src="http://file.isky.co.kr/images/svc/svc_txt_06.gif"></td>
													</tr>
													<tr>
														<td rowspan="10" CLASS="TD1" width="98"><div align="left">정상적인 사용중 발생한&nbsp; 
																기능상의&nbsp;고장 발생시<BR>
																(비 고장성이나&nbsp;<BR>
																과실성은 제외됨)</div>
														</td>
														<td colspan="2" CLASS="TD1" width="308"><div align="left">구입 후 10일 이내 중요한 수리를 요할 때</div>
														</td>
														<td CLASS="TD3" width="128">제품교환 또는 환불</td>
														<td rowspan="4" CLASS="TD3">해당 없음</td>
													</tr>
													<tr>
														<td colspan="2" CLASS="TD1"><div align="left">구입 후 1개월 이내 중요한 수리를 요할 때</div>
														</td>
														<td CLASS="TD3">제품교환</td>
													</tr>
													<tr>
														<td colspan="2" CLASS="TD1"><div align="left">교환된 제품이 1개월 이내에 중요한 수리를 요하는 고장 발생시</div>
														</td>
														<td rowspan="2" CLASS="TD3">환불</td>
													</tr>
													<tr>
														<td colspan="2" CLASS="TD1"><div align="left">교환 불가능 시</div>
														</td>
													</tr>
													<tr>
														<td rowspan="3" CLASS="TD1"><div align="left">수리<br>
																가능</div>
														</td>
														<td CLASS="TD1"><div align="left">동일 하자로 3회까지 고장 발생시</div>
														</td>
														<td CLASS="TD3">무상수리</td>
														<td CLASS="TD3">유상 수리</td>
													</tr>
													<tr>
														<td CLASS="TD1"><div align="left">동일 하자로 4회째 고장 발생시</div>
														</td>
														<td rowspan="5" CLASS="TD3">제품교환 또는 환불</td>
														<td CLASS="TD3">유상 수리</td>
													</tr>
													<tr>
														<td CLASS="TD1"><div align="left">서로 다른 하자로 5회째 고장 발생시</div>
														</td>
														<td CLASS="TD3">유상 수리</td>
													</tr>
													<tr>
														<td colspan="2" CLASS="TD1"><div align="left">소비자가 수리 의뢰한 제품을 사업자가 분실한 경우</div>
														</td>
														<td rowspan="2" CLASS="TD3">정액 감가상각한<br>
															금액에 10%를<br>
															가산하여 환불</td>
													</tr>
													<tr>
														<td colspan="2" CLASS="TD1"><div align="left">부품보유기간 이내 수리용 부품을 보유하고 있지 않아 수리가 불가능한 경우</div>
														</td>
													</tr>
													<tr>
														<td colspan="2" CLASS="TD1"><div align="left">수리용 부품은 있으나 수리 불가능 시</div>
														</td>
														<td CLASS="TD3">정액 감가 상각후 환불</td>
													</tr>
												</table>
												<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
													<tr>
														<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:4px; PADDING-TOP:20px"><img src="http://file.isky.co.kr/images/svc/svc_txt_02_01.gif"></td>
													</tr>
													<TR>
														<TD HEIGHT="3" bgcolor="#dddddd"></TD>
													</TR>
													...
													<tr>
														<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:20px; PADDING-TOP:10px"><IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="6">
															<b>고장이 아닌 경우</b><br>
															&nbsp;&nbsp;- 고장이 아닌 경우 서비스를 요청하면 요금을 받게 되므로 반드시 사용설명서를 읽어주세요. <br><br>
															<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="6">
															<b>소비자 과실로 고장난 경우</b><br>
															&nbsp;&nbsp;- 소비자의 취급 부주의(침수,충격)로 인한 고장 발생시 <br>
															&nbsp;&nbsp;- 소비자가 함부로 수리,개조하여 고장 발생시 <br>
                          &nbsp;&nbsp;- SKY 기사 및 지정 협력사 기사가 아닌 사람이 수리 하여 고장 
                          발생시 <br>
															&nbsp;&nbsp;- SKY에서 제공하지 않은 별매품 구입 사용으로 고장 발생시 <br>
															&nbsp;&nbsp;- 기타 부주의로 인한 고장, 손상 발생시 <br><br>
															<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray2.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="6">
															<b>그 밖의 경우</b><br>
															&nbsp;&nbsp;- 천재지변(화재,염해,수해 등)에 의한 고장 발생 시 <br>
															&nbsp;&nbsp;- 소모성 부품의 수명이 다한 경우<br>
														    &nbsp;&nbsp;&nbsp;&nbsp;(배터리,진동자,안테나,이어마이크,충전기 접속단자 및 각종 부착물)
