...
<ul>
	...
	<li><a href="/svc/svcMedia.do"><img alt="MEDIA LIVE" src="/img/layout/nav/snb_service04_off.gif" /></a></li>
		...
		<div id="container">
			<div class="location">
				<a href="#">HOME</a><em>베가 라이프</em>
			</div>

			<div class="serviceList">
				<h2>
					<img src="/img/contents/service/tit_smart_service.gif" alt="Smart Service 베가 라이프란?" />
					<span class="blind">세상에 없던 세상을 만드는 기술을 통해 상상을 현실로 만들어 갑니다.<br />새로운 세상 VEGA 베가 라이프!</span>
				</h2>
				<ul class="clfix">
					<li class="first odd">
						<a href="/svc/svcApps.do" class="hoverImg">
							<img src="/img/contents/service/txt_service_list01_off.gif" class="txt" alt="AppsPlay" />
							<img src="/img/contents/service/img_service_list01.jpg" alt="게임, 영화, TV, 음악까지 다양한 분야의 컨텐츠 App을  VEGA AppsPlay에서 만나세요." />
						</a>
					</li>
					<li>
						<a href="/svc/svcCloud.do" class="hoverImg">
							<img src="/img/contents/service/txt_service_list02_off.gif" class="txt" alt="Cloud Live" />
							<img src="/img/contents/service/img_service_list02.jpg" alt="사진 동영상 문서가 클라우드에 바로 저장되고 쉽게 공유할 수 있습니다" />
						</a>
					</li>
					<li class="odd">
						<a href="/svc/svcFlux.do" class="hoverImg">
							<img src="/img/contents/service/txt_service_list03_off.gif" class="txt" alt="FLUX" />
							<img src="/img/contents/service/img_service_list03.jpg" alt="VEGA 의 FLUX는 사용자,디바이스,서비스 간의 중심 매개체로서 객체간 끊임없는 상호작용의 흐름(FLUX)을 제공하는 UX입니다." />
						</a>
					</li>
					<li>
						<a href="/svc/svcMedia.do" class="hoverImg">
							<img src="/img/contents/service/txt_service_list04_off.gif" class="txt" alt="Media Live" />
							<img src="/img/contents/service/img_service_list04.jpg" alt="집에 있는 내 PC에 저장된 동영상, 음악, 사진 콘텐츠를 작업 없이 내가 가진 모바일 기기에서 언제 어디서나 감상 할 수 있습니다." />
						</a>
					</li>
					<!-- 
					<li class="odd">
						<a href="/svc/svcSky9.do" class="hoverImg">
							<img src="/img/contents/service/txt_service_list05_off.gif" class="txt" alt="VEGA9" />
							<img src="/img/contents/service/img_service_list05.jpg" alt="언제 어디서나 함께하는 즐거움! Enjoy Together" />
						</a>
					</li>
					 -->
				</ul>
			...
			<div class="footBbs">
				...
				<div class="mask">
					<ul id="footerNotice">
						...
						<li><a href="http://www.ivega.co.kr/notice/noticeView.do?intseq=1629">VEGA R3 제품등록 일시 중단 안내</a></li>
					
						<li><a href="http://www.ivega.co.kr/notice/noticeView.do?intseq=1627">2012년 11월 1일 포인트 소멸에 대한 안내</a></li>
				...
				<div class="mask">
					<ul id="footerSw">
						...
						<li><a href="http://www.ivega.co.kr/news/newsView.do?intseq=5011">‘베가 R3’ 탄생 기념 ‘타운 세일즈’ 신개념 마케팅활동 펼쳐</a></li>
