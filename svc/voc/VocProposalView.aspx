...
<HTML>
	...
	<Meta_Title value="고객제안마당 내용" />
	<Meta_From value="isky" />
		<Meta_Path value="Home:고객지원:고객의소리:고객제안마당" />
		<form name="Form1" method="post" action="VocProposalView.aspx" id="Form1">
<input type="hidden" name="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" value="" />
	...
	<tr>
		<td>
			<OBJECT id="navigation" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
				...
				<embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E42" width=222 height=475 />
			</OBJECT>
		</td>
	</tr>
	<tr>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fvoc%2fVocProposalView.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fvoc%2fVocProposalView.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV class="CONTENTS">
								<!--본문내용 들어가는 곳//-->
								<DIV ID="CONTENTS">
									<DIV CLASS="LINEMAP"><a href="/" class=gray>Home</a> &gt; <a href="../../Main.aspx" class=gray>고객지원</a> &gt; <a href="VocMain.aspx" class=gray>고객의 소리</a> &gt; 고객제안마당</DIV>
									<IMG SRC="http://file.isky.co.kr/images/svc/voice_title02.gif"><BR>
									<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" CLASS="BD2">
										<TR>
											<TD><IMG SRC="http://file.isky.co.kr/images/svc/voice_title_txt02.gif"><br>
												<!--a href="javascript:jsPopUpLogin('/Svc/voc/VocProposalView.aspx?');"><IMG SRC="http://file.isky.co.kr/images/svc/btn_modify_memberinfo.gif" style="MARGIN:0px 0px 11px 13px"></a--></TD>
											<TD ALIGN="right" valign="bottom"><IMG SRC="http://file.isky.co.kr/images/svc/voice_title_02_illust.gif"></TD>
										</TR>
									</TABLE>
									<DIV ID="CONTENTS_SUB" STYLE="PADDING-TOP:20px">
										...
										<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
											<TR>
												<TD COLSPAN="6" CLASS="BBS_READ_TT"><span id="lblVocTitle"></span></TD>
											</TR>
											<TR HEIGHT="28" STYLE="PADDING-TOP:4px">
												<TD WIDTH="108" CLASS="BBS_READ_TAB2">분류</TD>
												<TD WIDTH="171" CLASS="BBS_READ_TAB"><span id="lblVocCateName"></span></TD>
												<TD WIDTH="108" CLASS="BBS_READ_TAB2">작성자</TD>
												<TD WIDTH="134" CLASS="BBS_READ_TAB"><span id="lblUserName"></span></TD>
												<TD WIDTH="58" CLASS="BBS_READ_TAB2">추천</TD>
												<TD WIDTH="91" CLASS="BBS_READ_TAB"><span id="lblRecCnt"></span>
													<a id="lbtnRecd" onclick="javascript:jsPopUpLogin('/Svc/voc/VocProposalView.aspx?'); return false;" href="javascript:__doPostBack('lbtnRecd','')">
										...
										<DIV class="BBS_READ_CON" style="height:300">
											<span id="lblContent"></span><BR>
										</DIV>
										<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
											<TR>
												<TD COLSPAN="2" HEIGHT="4" BGCOLOR="#e7d2d2"></TD>
											</TR>
										</TABLE>
										<!-- 버튼들 -->
										<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" STYLE="MARGIN-BOTTOM:7px">
											<TR>
												<TD ALIGN="right" HEIGHT="43" STYLE="PADDING-TOP:6px">
												...
												<td>&nbsp;														
													...
													<A href="VocProposalList.aspx?NOWPAGE="><IMG 
            src="http://file.isky.co.kr/images/com/bbs_button_list.gif" 
            align=absMiddle></A>
												</td>
												</tr>
												</table>
...
//-->
		...
		<script language='JavaScript'>location.href='VocProposalList.aspx';</script>
