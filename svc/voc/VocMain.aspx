...
<HTML>
	<HEAD>
		...
		function OpenPopup(){
			var eventCookie=getCookie("setEventPopUp");
			if (eventCookie != "no")
			window.open('./event_0404.htm', 'EvPopup', 'width=450, height=350, left=100, top=100, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');
		}
	...
	<Meta_Title value="고객의소리 서브 메인" />
	<Meta_From value="isky" />
	<Meta_Path value="Home:고객지원:고객의소리" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E4" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E4" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fvoc%2fVocMain.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fvoc%2fVocMain.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
						...
						<DIV class="CONTENTS">		
						<!--본문내용 들어가는 곳//-->
		<DIV class="LINEMAP"><a href="/" class=gray>Home</a> &gt; <a href="../../Main.aspx" class=gray>고객지원</a> &gt; 고객의 소리</DIV CLOSE="LINEMAP">



			<img src="http://file.isky.co.kr/images/svc/voice_title_main.gif"><BR>


			<table CELLPADDING="0" CELLSPACING="0">
				<tr>
					<td><img src="http://file.isky.co.kr/images/svc/voice_img01.gif" usemap="#voc_main_01"></td>
					<td><img src="http://file.isky.co.kr/images/svc/voice_img02.gif" usemap="#voc_main_02"></td>
				</tr>

				<map name="voc_main_01">
					<area shape="rect" coords="20,18,148,45" href="/svc/voc/VocThankList.aspx" onfocus="this.blur()">
				</map>
				<map name="voc_main_02">
					<area shape="rect" coords="18,18,138,45" href="/svc/voc/VocProposalList.aspx" onfocus="this.blur()">
				</map>

				<tr>
					<td background="http://file.isky.co.kr/images/svc/voice_img03.gif" width="346" height="117" valign="top">
						<div style="padding:10 0 0 115">

						
								<A HREF="VocThankView.aspx?idx=170973">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">노원점 7번 a/s 이충언 7 </span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocThankView.aspx?idx=171749">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">친절한..돈암 서비스센터~~~</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocThankView.aspx?idx=171670">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">서초서비스센터 다녀와서~</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocThankView.aspx?idx=171495">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">친절 하시더군요</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocThankView.aspx?idx=171553">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK"> 불만많던 휴대폰이 있었기에</span></A><BR>
								
								
						
						</div>
					</td>
					<td background="http://file.isky.co.kr/images/svc/voice_img04.gif" width="344" height="117" valign="top">
						<div style="padding:10 0 0 112">
					
						
								<A HREF="VocProposalView.aspx?idx=170424">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">관리자님 꼭 봐주세요...</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocProposalView.aspx?idx=169460">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">이렇게만 된다면.. 모든 사람이</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocProposalView.aspx?idx=168728">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">부가기능 추가</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocProposalView.aspx?idx=169077">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">점점 진화하는 SKY핸드폰에 대</span></A><BR>
								<img src='http://file.isky.co.kr/images/svc/voice_main_line01.gif' width='211' height='1'><br>
							
								<A HREF="VocProposalView.aspx?idx=169045">
								<IMG src="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3"><span CLASS="GRAY_DARK">IM-8500 벨소리 제안이요.</span></A><BR>
			...
			<TR VALIGN="TOP">
				<TD style="padding:8 0 9 0">
					<TABLE CELLPADDING="0" CELLSPACING="0" ALIGN="CENTER">
					<TR VALIGN="TOP">
						<TD WIDTH="345" ALIGN="CENTER" style="padding:10 0 0 0"><img src="http://file.isky.co.kr/images/svc/voice_main_img01.gif" usemap="#discontent"></TD>
						<td width="1"><img src="http://file.isky.co.kr/images/svc/voice_main_line02.gif" width="1" height="94"></td>
						<TD WIDTH="345" ALIGN="CENTER" style="padding:10 0 0 0"><img src="http://file.isky.co.kr/images/svc/voice_main_img02.gif"></TD>
					</TR>
					</TABLE>
				</TD>
			</TR>
			...
			<map name="discontent">
				<area shape="rect" coords="85,58,150,120" href="/svc/voc/VocDissSatiReg.aspx" onfocus="this.blur()">
			</map>
