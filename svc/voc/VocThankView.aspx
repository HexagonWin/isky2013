...
<HTML>
	...
	<Meta_Title value="고객감동스토리 내용" />
	<Meta_From value="isky" />
		<Meta_Path value="Home:고객지원:고객의소리:고객감동스토리" />
		<form name="Form1" method="post" action="VocThankView.aspx" id="Form1">
<input type="hidden" name="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" value="" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fvoc%2fVocThankView.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fvoc%2fVocThankView.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV CLASS="CONTENTS">
								<!--본문내용 들어가는 곳//-->
									...
									<DIV CLASS="LINEMAP"><a href="/" class=gray>Home</a> &gt; <a href="../../Main.aspx" class=gray>고객지원</a> &gt; <a href="VocMain.aspx" class=gray>고객의 소리</a>&gt; 고객감동스토리</DIV>
									...
									<TABLE class="BD2" cellSpacing="0" cellPadding="0" width="100%">
										<TR>
											<TD><IMG src="http://file.isky.co.kr/images/svc/voice_title_txt01.gif"><br>
												<!--A href="javascript:jsPopUpLogin('/Svc/voc/VocThankView.aspx?');"><IMG style="MARGIN: 0px 0px 11px 13px" src="http://file.isky.co.kr/images/svc/btn_modify_memberinfo.gif"></A-->
											</TD>
									...
									<DIV id="CONTENTS_SUB" style="PADDING-TOP: 20px">
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD class="BBS_READ_TT" colSpan="6"><span id="lblVocTitle"></span></TD>
											</TR>
											<TR style="PADDING-TOP: 4px" height="28">
												<TD class="BBS_READ_TAB2" width="108">분류</TD>
												<TD class="BBS_READ_TAB" width="171"><span id="lblVocCateName"></span></TD>
												<TD class="BBS_READ_TAB2" width="108">작성자</TD>
												<TD class="BBS_READ_TAB" width="134"><span id="lblUserName"></span></TD>
												<TD class="BBS_READ_TAB2" width="58">추천</TD>
												<TD class="BBS_READ_TAB" width="91"><span id="lblRecCnt"></span>
													<a id="lbtnRecd" onclick="javascript:jsPopUpLogin('/Svc/voc/VocThankView.aspx?'); return false;" href="javascript:__doPostBack('lbtnRecd','')">
														<IMG id="imgRecd" align="absMiddle"></a></TD>
											</TR>
											<TR>
												<TD bgColor="#e7d2d2" colSpan="6"></TD>
											</TR>
											<TR style="PADDING-TOP: 4px" height="28">
												<TD class="BBS_READ_TAB2">번호</TD>
												<TD class="BBS_READ_TAB"><span id="lblVocID"></span></TD>
												<TD class="BBS_READ_TAB2">작성일</TD>
												<TD class="BBS_READ_TAB"><span id="lblVocRegDate"></span></TD>
												<TD class="BBS_READ_TAB2">조회</TD>
												<TD class="BBS_READ_TAB"><span id="lblHitCnt"></span></TD>
											</TR>
											<TR>
												<TD bgColor="#e7d2d2" colSpan="6"></TD>
											</TR>
										...
										<DIV class="BBS_READ_CON" style="height:300"><span id="lblContent"></span><BR>
										</DIV>
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD bgColor="#e7d2d2" colSpan="2" height="4"></TD>
											</TR>
										</TABLE>
										<!-- 버튼들 -->
										<TABLE style="MARGIN-BOTTOM: 7px" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD style="PADDING-TOP: 6px" align="right" height="43">
												
												<table cellSpacing="0" cellPadding="0" border=0 align="right">
												<tr>
												<td>
													<A style="CURSOR: hand" onclick="window.open('VocPrint.aspx?idx=0','win','width=689,height=500,scrollbars=yes,status=no');"><IMG SRC="http://file.isky.co.kr/images/com/bbs_button_print.gif" align="absMiddle"></A>&nbsp;
												</td>

												<td>&nbsp;
													<A href="VocThankList.aspx?NOWPAGE="><IMG src="http://file.isky.co.kr/images/com/bbs_button_list.gif" align=absMiddle></A>
												</td>
												</tr>
												</table>
...
<SCRIPT language=JavaScript src="http://file.isky.co.kr/js/AceCounterRun.js"></SCRIPT></td>
			...
			<!-- 
			// LinkButton 이미지 세팅
			document.all["imgRecd"].src="http://file.isky.co.kr/images/com/bbs_button_recom.gif"
			//-->
			</SCRIPT>
		<script language='JavaScript'>location.href='VocThankList.aspx';</script>
