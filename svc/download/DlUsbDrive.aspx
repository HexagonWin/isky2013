...
<HTML>
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="다운로드 USB드라이버" />
		<Meta_From Value="isky" />
		<Meta_Path Value="Home:고객지원:다운로드:USB드라이버" />
		<form name="Form1" method="post" action="DlUsbDrive.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwxMDA0MDkxMjAyOzs+" />
	...
	<tr>
		<td>
			<OBJECT id="navigation" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
				...
				<PARAM NAME="Movie" VALUE="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E33">
				<embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E33" width=222 height=475 />
			</OBJECT>
		</td>
	</tr>
	<tr>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fdownload%2fDlUsbDrive.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
//			document.location.href = "http://www.isky.co.kr/mobile/photo/photo_list.asp?category_code=402";
	...
	*/	
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fdownload%2fDlUsbDrive.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV class="CONTENTS">
								...
								<IMG SRC="http://file.isky.co.kr/images/svc/download/download_title03.gif"><BR>
								<TABLE class="BD2" cellSpacing="0" cellPadding="0" width="100%">
									<TR>
										<TD><IMG src="http://file.isky.co.kr/images/svc/download/download_title_txt03.gif" ></TD>
										<TD vAlign="bottom" align="right"><IMG src="http://file.isky.co.kr/images/svc/download/download_title_03_illust.gif" ></TD>
									</TR>
								</TABLE>
								...
								<table CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
									...
									<tr height="68">
										...
										<td CLASS="TD2">
											<P style="PADDING-BOTTOM:4px"><a href="JavaScript:DownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?DOWN_ID=USB&SEQ=33')"><img src='http://file.isky.co.kr/images/svc/download/download_btn03_01.gif'></a></P>
											<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
											IM-7700 이상부터는 데이터매니저가 USB드라이버를 자동설치하므로 별도로 설치하실 필요가 없습니다.
											<P style="PADDING-BOTTOM:4px"><a href="JavaScript:DownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?DOWN_ID=USB&SEQ=36')"><img src='http://file.isky.co.kr/images/svc/download/download_btn_U100.gif'></a></P>
											
                  <IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4"> 
                  IM-U100 USB 드라이버입니다.
<P style="PADDING-BOTTOM:4px"><a href="JavaScript:DownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?DOWN_ID=USB&SEQ=34')"><img src='http://file.isky.co.kr/images/svc/download/download_btn_8500L.gif'></a></P>
											<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
											IM-8500L USB 드라이버 Ver 4.34 입니다.
										</td>
									</tr>
									<tr>
										<td colspan="2" height="1" bgcolor="#e7d2d2"><FONT face="굴림">&nbsp;</FONT></td>
									</tr>
									<tr height="78">
										<td CLASS="TD1" style="WIDTH: 95px"><IMG SRC="http://file.isky.co.kr/images/svc/download/download_txt03_02.gif"></td>
										<td CLASS="TD2" style="line-height:180%;height:130px"><IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
											USB 드라이버 Ver4.22는 Hyper Threading 관련 Setting을 포함한 버전입니다.<br>
											<img src="http://file.isky.co.kr/images/com/spacer.gif" height="5" width="1"><br>
											<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
											USB 드라이버 Ver4.22는 Ver4.20의 자동설치 버전으로, Ver4.20을 기설치하신 분은<br>
											&nbsp;&nbsp;재설치 하실 필요가 없습니다.<br>
											<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4"> USB 드라이버 Ver 4.34는 IM-8500L 의 설치 버전으로,<br>
&nbsp;&nbsp;자신의 PC에 USB 드라이버 4.22 버전이 이미 설치되어 있는 경우, <br>
&nbsp;&nbsp;<b>4.22 버전은 삭제하시고 4.34 버전을 새롭게 설치</b>하셔야 합니다.
									...
									<tr height="99">
										<td CLASS="TD1" style="WIDTH: 95px"><IMG SRC="http://file.isky.co.kr/images/svc/download/download_txt03_03.gif"></td>
										<td><A href="#"><IMG src="http://file.isky.co.kr/images/svc/download/download_btn03_02.gif" onclick="window.open('http://file.isky.co.kr/PDS01/2006/PRD/480/SKY_USB_v436_GUIDE[20060201153958].zip','DDalraeWin','width=800,height=600,top=0,left=320,scrollbars=yes,toolbar=yes,alwaysRaised=no,location=no,status=no,menubar=no,screenX=0,screenY=0');" vspace="5" hspace="5"></A><br>
											<A href="#"><IMG src="http://file.isky.co.kr/images/svc/download/download_btn03_03.gif" onclick="window.open('http://file.isky.co.kr/PDS01/2006/PRD/480/SKY_USB_v436_GUIDE[20060201153958].zip','DDWin','width=800,height=600,top=0,left=320,scrollbars=no,toolbar=no,alwaysRaised=no,location=no,status=no,menubar=no,screenX=0,screenY=0');" vspace="5" hspace="5"></A><br>
											<!--<A href="#"><IMG src="http://file.isky.co.kr/images/svc/download/download_btn03_05.gif" onclick="window.open('http://file.isky.co.kr/PDS01/2006/PRD/406/통합_USB드라이버_설치방법.doc','UDWin','width=800,height=600,top=0,left=320,scrollbars=no,toolbar=no,alwaysRaised=no,location=no,status=no,menubar=no,screenX=0,screenY=0');" vspace="5" hspace="5"></A><br>-->
											<A href="#"><IMG src="http://file.isky.co.kr/images/svc/download/download_btn03_04.gif" onclick="window.open('http://file.isky.co.kr/content/USB드라이버 버전 확인 방법.pdf','DDalrae','width=800,height=600,top=0,left=320,scrollbars=no,toolbar=no,alwaysRaised=no,location=no,status=no,menubar=no,screenX=0,screenY=0');" vspace="5" hspace="5"></A></td>
									</tr>
									<tr>
										<td colspan="2" height="1" bgcolor="#e7d2d2"></td>
									</tr>
								...
								<TABLE WIDTH="690" CELLPADDING="0" CELLSPACING="0" CLASS="BD">
									<tr>
										<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:13px; PADDING-TOP:9px"
											align="center">
											<table WIDTH="660" CELLPADDING="0" CELLSPACING="0">
												<tr>
													<td><img src="http://file.isky.co.kr/images/svc/download/download_bg_03.gif" width="1" height="23"></td>
													<td bgcolor="#8d6164" width="658" style="PADDING-LEFT:10px"><img src="http://file.isky.co.kr/images/svc/download/download_txt03_04.gif" width="183" height="16"></td>
													<td><img src="http://file.isky.co.kr/images/svc/download/download_bg_03.gif" width="1" height="23"></td>
												</tr>
												<tr>
													<td colspan="3" style="PADDING-LEFT:12px;PADDING-TOP:25px">
														<span class="BROWN_SEARCHb">시작-제어판-시스템-하드웨어-장치관리자로 이동</span><br>
														1) 모뎀 SKY IMT-2000 Handset #xx<br>
														2) 범용 직렬버스 컨트롤러 -&gt; SKY USB Composite Device<br>
														3) 포트(COM 및 LPT -&gt; SKY IMT-2000 Handset Diagnostic Serial Port(WDM)(COMx)<br>
														<br>
														<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
														상기의 3개 항목 존재시 USB 설정 완료 상태임<br>
														<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
														각 장치에서 오른쪽 마우스를 클릭한 후 '속성' (WinXP인 경우)/ 등록정보'(Win2000인 경우) 버튼을 선택 -&gt;
														<br>
														<IMG SRC="http://file.isky.co.kr/images/svc/download/download_ico_plus.gif" vspace="4">
														드라이버 탭 선택 -&gt; 버전 확인
													</td>
