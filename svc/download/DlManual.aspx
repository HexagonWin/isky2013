...
<HTML>
	<HEAD>
		...
		<meta content=http://schemas.microsoft.com/intellisense/ie5 name=vs_targetSchema><LINK title=SKTT href="http://file.isky.co.kr/css/default.css" 
type=TEXT/CSS rel=STYLESHEET>
	...
	<Meta_Title value="사용설명서 다운로드" />
	<Meta_From Value="isky" />
	<Meta_Path Value="Home:고객지원:다운로드:사용설명서" />	
		<form name="Form1" method="post" action="DlManual.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="" />

			<div 
style="BACKGROUND-IMAGE: url(http://file.isky.co.kr/images/com/bg_top.jpg); WIDTH: 100%; BACKGROUND-REPEAT: repeat-x; HEIGHT: 100%" DESIGNTIMEDRAGDROP="12">
				<table 
	...
	<tr>
		<td>
			<OBJECT id="navigation" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
				...
				<PARAM NAME="Movie" VALUE="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E31">
				<embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E31" width=222 height=475 />
			</OBJECT>
		</td>
	</tr>
	<tr>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fdownload%2fDlManual.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fdownload%2fDlManual.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
            ...
            src="http://file.isky.co.kr/images/svc/download/download_title02.gif" 
            >
											<TABLE class=BD2 cellSpacing=0 cellPadding=0 width="100%">
												<TR>
													<TD><IMG 
                  src="http://file.isky.co.kr/images/svc/download/download_title_txt02.gif" 
                  ></TD>
													<TD vAlign=bottom align=right><IMG 
                  src="http://file.isky.co.kr/images/svc/download/download_title_02_illust.gif" 
                  ></TD></TR></TABLE><IMG height=20 
            src="http://file.isky.co.kr/images/com/spacer.gif" width=1 
            ><BR>
											<TABLE cellSpacing=0 cellPadding=0 width=690>
												<tr>
													<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 5px; PADDING-BOTTOM: 7px; PADDING-TOP: 0px"><img height=12 
                  src="http://file.isky.co.kr/images/svc/download/download_txt05_01.gif" 
                  width=308></td>
													<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 10px; PADDING-TOP: 0px" align=right><input name="ScripSelect1:TxtOptsHtml" id="ScripSelect1_TxtOptsHtml" type="hidden" value="<OPTION VALUE='IMB-1000'>IMB-1000 계열</OPTION><OPTION VALUE='IM-8000'>IM-8000 계열</OPTION><OPTION VALUE='IM-7000'>IM-7000 계열</OPTION><OPTION VALUE='IM-6000'>IM-6000 계열</OPTION><OPTION VALUE='IM-5000'>IM-5000 계열</OPTION><OPTION VALUE='IM-3000'>IM-3000 계열</OPTION><OPTION VALUE='IM-2000'>IM-2000 계열</OPTION><OPTION VALUE='IM-1000'>IM-1000 계열</OPTION><OPTION VALUE='IM-700'>IM-700 계열</OPTION>" />
<input name="ScripSelect1:TxtSelValue" id="ScripSelect1_TxtSelValue" type="hidden" value="IMB-1000" />
...
function GetXmlHttpHtml(PageParam, Param)
{
	...
	//현재페이지의 명
//	PageName = "http://www.isky.co.kr"+"/Svc/download/DlManual.aspx?"+PageParam;
	PageName = "DlManual.aspx?"+PageParam;
...
<SCRIPT language="Javascript">
<!--
var SSOBJ_1 = SELECT("<SELECT ID='SS_1' NAME='SS_1' STYLE='WIDTH:130PX;' onchange=DoPostBackSS1('SS_1')><OPTION VALUE=''>제품계열</OPTION><OPTION VALUE='IMB-1000'>IMB-1000 계열</OPTION><OPTION VALUE='IM-8000'>IM-8000 계열</OPTION><OPTION VALUE='IM-7000'>IM-7000 계열</OPTION><OPTION VALUE='IM-6000'>IM-6000 계열</OPTION><OPTION VALUE='IM-5000'>IM-5000 계열</OPTION><OPTION VALUE='IM-3000'>IM-3000 계열</OPTION><OPTION VALUE='IM-2000'>IM-2000 계열</OPTION><OPTION VALUE='IM-1000'>IM-1000 계열</OPTION><OPTION VALUE='IM-700'>IM-700 계열</OPTION></SELECT>", 'SS_1', '10');
var SelFlag1 = false;


	var SelectHTML = "<SELECT ID='SS_1' NAME='SS_1' STYLE='WIDTH:130PX;' onchange=DoPostBackSS1('SS_1')><OPTION VALUE=''>제품계열</OPTION><OPTION VALUE='IMB-1000'>IMB-1000 계열</OPTION><OPTION VALUE='IM-8000'>IM-8000 계열</OPTION><OPTION VALUE='IM-7000'>IM-7000 계열</OPTION><OPTION VALUE='IM-6000'>IM-6000 계열</OPTION><OPTION VALUE='IM-5000'>IM-5000 계열</OPTION><OPTION VALUE='IM-3000'>IM-3000 계열</OPTION><OPTION VALUE='IM-2000'>IM-2000 계열</OPTION><OPTION VALUE='IM-1000'>IM-1000 계열</OPTION><OPTION VALUE='IM-700'>IM-700 계열</OPTION></SELECT>";
	if(0 <= SelectHTML.indexOf('IMB-1000'))
	{
		var SelObj = document.getElementById('SS_1');
		if(null != SelObj)
		{
			SelObj.value = "IMB-1000";
...
//-->	
											...
											<IMG 
            height=10 src="http://file.isky.co.kr/images/com/spacer.gif" width=1 
            ><BR>
											<table style="BORDER-RIGHT: #f1e5e5 1px solid; BORDER-TOP: #f1e5e5 1px solid; BORDER-LEFT: #f1e5e5 1px solid; BORDER-BOTTOM: #f1e5e5 1px solid" cellSpacing=0 cellPadding=0 width=690>
												<tr>
													<td colSpan=3 height=20></td></tr>
												<tr>
													<td style="PADDING-LEFT: 14px" align=left><table id="dlItem" cellspacing="0" border="0">
	<tr>
		<td colspan="2">
		...
		<td>
																<div>
																	<table width=303 cellpadding="0" cellspacing="15">
																		<tr>
																			<td class="BD3" width="103" align="center">
																				<span id="dlItem__ctl1_lblImg"><img src='http://file.isky.co.kr/ATT01/2005/PRD/405/info_pic_IMB1000_s[20050425155905].jpg'></span>
																			</td>
																			<td>
																				<img src="http://file.isky.co.kr/images/com/bullet_arrow_red.gif" align=absmiddle vspace=10>
																				<span class="brown_searchb">
																					<span id="dlItem__ctl1_lblPrdID">IMB-1000</span></span><br>
																				<span id="dlItem__ctl1_lblCopy">위성DMB와 EV-DO 서비스를 최대화한 슬라이드 폰</span><br>
																				<span id="dlItem__ctl1_lblMAN"><a href="JavaScript:DownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?PRD_ID=IMB-1000&DOWN_ID=USM&SEQ=1')"><img src='http://file.isky.co.kr/images/svc/download/download_btn_manual.gif' vspace=5></a></span><br>
																				<span id="dlItem__ctl1_lblDMM"><a href="JavaScript:DownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?PRD_ID=IMB-1000&DOWN_ID=DMM&SEQ=1')"><img src='http://file.isky.co.kr/images/svc/download/download_btn_dm_pdf.gif' vspace=5></a></span>
																			</td>
																		</tr>
																	</table>
																</div>
...
<table style="BORDER-RIGHT: #f1e5e5 1px solid; BORDER-TOP: #f1e5e5 1px solid; BORDER-LEFT: #f1e5e5 1px solid; BORDER-BOTTOM: #f1e5e5 1px solid" cellSpacing=0 cellPadding=0 width=690>
												<tr>
													<td align=center bgColor=#fbf8f8>
														<table cellSpacing=0 cellPadding=0 width=669>
															<tr>
																<td width=183><a href="http://www.korea.adobe.com/products/acrobat/readstep2.html" target=_blank><IMG 
                        src="http://file.isky.co.kr/images/svc/download/download_img06.gif" 
                        ></a></td>
																<td colSpan=2><IMG 
                        src="http://file.isky.co.kr/images/svc/download/download_text05.gif" 
                        ></td></tr>
															<tr>
																<td bgColor=#f1e5e5 colSpan=3 height=1></td></tr>
															<tr>
																<td><IMG 
                        src="http://file.isky.co.kr/images/svc/download/download_img07.gif" 
                        ></td>
																<td><IMG 
                        src="http://file.isky.co.kr/images/svc/download/download_text04.gif" 
                        ></td>
																<td style="PADDING-RIGHT: 14px" align=right><A onclick="window.open('http://file.isky.co.kr/content/MVManual.htm','DDalraeWin','width=700,height=510,top=0,left=320,scrollbars=no,toolbar=no,alwaysRaised=no,location=no,status=no,menubar=no,screenX=0,screenY=0');" href="#"><IMG 
                        hspace=5 
                        src="http://file.isky.co.kr/images/svc/btn_view_mov.gif" 
...
<SCRIPT language=JavaScript src="http://file.isky.co.kr/js/AceCounterRun.js"></SCRIPT></td></tr></table>
