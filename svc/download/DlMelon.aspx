...
<HTML>
	...
	<Meta_Title value="다운로드 Melon" />
	<Meta_From Value="isky" />
	<Meta_Path Value="Home:고객지원:다운로드:Melon" />	
		<form name="Form1" method="post" action="DlMelon.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="" />
	...
	<tr>
		<td>
			<OBJECT id="navigation" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
				...
				<PARAM NAME="Movie" VALUE="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E35">
				<embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E35" width=222 height=475 />
			</OBJECT>
		</td>
	</tr>
	<tr>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fSvc%2fdownload%2fDlMelon.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fSvc%2fdownload%2fDlMelon.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
									...
									<td>
										<DIV class=CONTENTS>
											...
											<TABLE cellSpacing=0 cellPadding=0 width="100%">
												<TR>
													<td class=LINEMAP CLASS="SMALL">
														
													</td>
												</TR>
											</TABLE>
											<!-- 검색박스 시작 -->
											<IMG style="PADDING-TOP: 20px" src="http://file.isky.co.kr/images/svc/download/download_title04.gif">
											<TABLE class=BD2 cellSpacing=0 cellPadding=0 width="100%">
												<TR>
													<TD><IMG src="http://file.isky.co.kr/images/svc/download/download_title_txt04.gif" ></TD>
													<TD vAlign=bottom align=right><IMG src="http://file.isky.co.kr/images/svc/download/download_title_04_illust.gif" ></TD>
												</TR>
											</TABLE>
											
											<STYLE>
											.TD1 { PADDING-TOP:4PX; PADDING-LEFT:10PX; BACKGROUND-COLOR:#F5F0F1;  TEXT-ALIGN:CENTER;}
											.TD2 { PADDING-TOP:4PX; PADDING-LEFT:10PX; BACKGROUND-COLOR:#FFFFFF;}
											</STYLE>
											<IMG height=20 src="http://file.isky.co.kr/images/com/spacer.gif" width=1 ><BR>
											<!-- FAQ 검색 -->
											<TABLE cellSpacing=0 cellPadding=0 WIDTH="100%">
												<tr><td colspan="2" height=1 bgcolor=#e7d2d2></td></tr>
												<tr height="40">
													<td width="118" CLASS="TD1"><IMG SRC="http://file.isky.co.kr/images/svc/download/download_txt03_01.gif"></td>
													<td CLASS="TD2"><span id="lblLink1"><a href="JavaScript:DownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?DOWN_ID=MEL&SEQ=36');"><img src='http://file.isky.co.kr/images/svc/download/download_btn04_01.gif'></a></span></td>
												</tr>
												<tr><td colspan="2" height=1 bgcolor=#e7d2d2></td></tr>
											</TABLE>

											<img src="http://file.isky.co.kr/images/com/spacer.gif" height="20" width="1"><br>

											<TABLE WIDTH="690" CELLPADDING="0" CELLSPACING="0" CLASS="BD">
												<tr>
													<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:0px; PADDING-TOP:9px" align="center">
														<table WIDTH="660" CELLPADDING="0" CELLSPACING="0">
															<tr>
																<td><img src="http://file.isky.co.kr/images/svc/download/download_bg_03.gif" width="1" height="23"></td>
																<td bgcolor="#8d6164" width="658" style="PADDING-LEFT:10px"><img src="http://file.isky.co.kr/images/svc/download/download_txt04_01.gif"></td>
																<td><img src="http://file.isky.co.kr/images/svc/download/download_bg_03.gif" width="1" height="23"></td>
															</tr>
															<tr>
																<td colspan=3 style="PADDING-BOTTOM:20px;PADDING-TOP:20px" align="center">
																	<IMG SRC="http://file.isky.co.kr/images/svc/download/download_img04_01.gif">
																</td>
															</tr>
														</table>
													</td>
											...
											<TABLE WIDTH="690" CELLPADDING="0" CELLSPACING="0" CLASS="BD">
												<tr>
													<td style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:13px; PADDING-TOP:9px" align="center">
														<table WIDTH="660" CELLPADDING="0" CELLSPACING="0">
															<tr>
																<td><img src="http://file.isky.co.kr/images/svc/download/download_bg_03.gif" width="1" height="23"></td>
																<td bgcolor="#8d6164" width="658" style="PADDING-LEFT:10px"><img src="http://file.isky.co.kr/images/svc/download/download_txt04_02.gif"></td>
																<td><img src="http://file.isky.co.kr/images/svc/download/download_bg_03.gif" width="1" height="23"></td>
															</tr>
															<tr>
																<td colspan=3 style="PADDING-LEFT:12px;PADDING-TOP:15px">
																	<span class="BROWN_SEARCHb">다운받은 파일 경로</span><br>
																	<table>
																	<tr>
																	<td rowspan="2" valign=top width="60"><span class="BROWN_SEARCH">MP3</span></td>
																	<td>1) 멀티미디어 자료관리 -&gt; 미디어 앨범내 보관</td>
																	</tr>
																	<tr>
																	<td>2) JUNE -&gt; 다운로드 컨텐츠 -&gt; 미디어 앨범내 보관</td>
																	</tr>
																	</table>
																</td>
															</tr>
