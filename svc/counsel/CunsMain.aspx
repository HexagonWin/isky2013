...
<HTML>
	...
	function FAQSearchValidate()
	{
		var Text = document.getElementById("FAQSearchText").value;
		
		if(("" == Text) || ("질문을 입력하세요" == Text)) return false;
		
		return true;
	}
	
	function OnClickFAQSearchText()
	{
		if(!FAQSearchValidate()) document.getElementById("FAQSearchText").value = "";
	}
	
	function OnClickFAQSearchBtn()
	{
		var Text = document.getElementById("FAQSearchText").value;
		
		if(!FAQSearchValidate())
		{ 
			alert("질문을 입력하세요");
			document.getElementById("FAQSearchText").value = ""
			document.getElementById("FAQSearchText").focus();
			return;
		}
		
		document.location = "CunsFAQList.aspx?Title="+Text;
	}
	...
	<body leftMargin="0" topMargin="0">
		<Meta_Title value="고객상담 서브 메인" />
		<Meta_From value="isky" />
		<Meta_Path value="Home:고객지원:고객상담" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E21" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_customer.swf?code=E21" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fsvc%2fcounsel%2fCunsMain.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fsvc%2fcounsel%2fCunsMain.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
						...
						<DIV class="CONTENTS">
							<!--본문내용 들어가는 곳//-->
							<DIV class="LINEMAP" align="right"><a href="/" class=gray>Home</a>&nbsp;&gt;&nbsp;<a href="../../Main.aspx" class=gray>고객지원</a>&nbsp;&gt;&nbsp;고객상담</DIV>
							<img src="http://file.isky.co.kr/images/svc/counsel/main_title.gif" ><BR>
							<table cellSpacing="0" cellPadding="0" width="690">
								<tr vAlign="top" height="131">
									<td width=346 background="http://file.isky.co.kr/images/svc/counsel/main_top_bg_1.gif">
										<table cellSpacing="0" cellPadding="0" width="346">
											<tr height="78">
												<td colspan="3" valign="top">
													<!-- FAQ+ 링크 -->
													<div style="PADDING-RIGHT: 0px; PADDING-LEFT: 18px; PADDING-BOTTOM: 0px; PADDING-TOP: 18px"><A onfocus="this.blur()" href="CunsFAQList.aspx"><IMG height=22 src="http://file.isky.co.kr/images/com/spacer.gif" width=58></A></div>
												</td>
											</tr>
											<tr>
												<td width="23"></td>
												<td width="245"><INPUT id="FAQSearchText" style="WIDTH: 245" onclick="OnClickFAQSearchText()" value="질문을 입력하세요">
												</td>
												<td width="69">
													<INPUT id=FAQSearchBtn style="WIDTH: 52px; HEIGHT: 20px" onclick=OnClickFAQSearchBtn() type=image 
													src="http://file.isky.co.kr/images/com/bbs_button_search.gif" 
													align=absMiddle CLASS="NO" >
												</td>
											</tr>
										</table>
									</td>
									<td width="344"><img src="http://file.isky.co.kr/images/svc/counsel/main_top_bg_2.gif" useMap=#main_top_bg_2></td>
								</tr>
								<map name="main_top_bg_2">
									<area onfocus="this.blur()" shape="RECT" coords="16,17,107,44" href="CunsSelfView.aspx">
									<area onfocus="this.blur()" shape="RECT" coords="196,76,333,102" href="CunsSelfView.aspx">
								</map>
								<tr>
									<td vAlign=top width=346 background="http://file.isky.co.kr/images/svc/counsel/main_top_bg_3.gif" height=117>
										<div style="PADDING-RIGHT: 0px; PADDING-LEFT: 115px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px">
											
													<A HREF='CunsFAQView.aspx?FsID=1311'>
														<IMG SRC="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3">
														<span CLASS="GRAY_DARK">
															음악앨범 연속재생
														</span>
													</A>
													<BR>
									...
									<td vAlign=top width=344 background="http://file.isky.co.kr/images/svc/counsel/main_top_bg_4.gif" height=117>
										<div style="PADDING-RIGHT: 0px; PADDING-LEFT: 112px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px">
											
													<A HREF='CunsSelfView.aspx?FsID=1032'>
														<IMG SRC="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3">
														<span CLASS="GRAY_DARK">
															외부 스피커를 통하여 FM라디..
														</span>
													...
													<A HREF='CunsSelfView.aspx?FsID=1031'>
														<IMG SRC="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3">
														<span CLASS="GRAY_DARK">
															라디오 청취 시 잡음 발생는 ..
														</span>
													...
													<A HREF='CunsSelfView.aspx?FsID=1030'>
														<IMG SRC="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3">
														<span CLASS="GRAY_DARK">
															실내에서 휴대용 FM Radi..
														</span>
													...
													<A HREF='CunsSelfView.aspx?FsID=1029'>
														<IMG SRC="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3">
														<span CLASS="GRAY_DARK">
															MMS(컬러메일) 수신 시 용..
														</span>
													...
													<A HREF='CunsSelfView.aspx?FsID=1028'>
														<IMG SRC="http://file.isky.co.kr/images/com/bullet_dot_gray.gif" ALIGN="ABSMIDDLE" CLASS="BLT" VSPACE="6" hspace="3">
														<span CLASS="GRAY_DARK">
															접속이 되지 않습니다.
														</span>
							...
							<!-- 고객불만접수 & 고객전화상담  -->
							<TABLE class="BD" cellSpacing="0" cellPadding="0" width="690">
								<TR vAlign="top">
									<TD>
										<TABLE cellSpacing="0" cellPadding="0" align="center">
											<TR>
												<TD WIDTH="345" ALIGN="CENTER"><img src="http://file.isky.co.kr/images/svc/banner_email.gif" usemap="#banner_email"></TD>
												<td width="1"><img src="http://file.isky.co.kr/images/svc/voice_main_line02.gif" width="1" height="94"></td>
												<TD WIDTH="345" ALIGN="CENTER"><img src="http://file.isky.co.kr/images/svc/voice_main_img02.gif"></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
							</TABLE>
							<map name="banner_email">
								<area onfocus="this.blur()" shape="RECT" coords="100,60,150,100" href="CunsEmailReg.aspx">
							</map>
