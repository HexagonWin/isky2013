...
<script language=javascript>
	function goList(){		
		...
		document.location.href = "/shop/product/modelView.asp?menuCode=D51";
...
<Meta_Title value='액세서리 주문실패'>
<Meta_From value='isky'>
<Meta_Path value='Home::액세서리:주문실패'>
<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
<tr valign="top" height="100%">
	<!-- LEFT 시작 -->
		
	<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=/shop/order/order_error.asp?" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
	</iframe>
...
-->		 
	...
	<tr valign="top" height="100%">
		<td width="690" nowrap>
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
		<form name=order_error method=post action="">
		...
		<tr>
			<td style="padding:10 0 20 4;"><img src="http://file.isky.co.kr/images/shop/accessory/title_orderFall.gif"></td>
		</tr>
		<tr>
			<td><img src="http://file.isky.co.kr/images/shop/accessory/img_orderFall.gif"></td>
		</tr>
		<tr>
			<td align="center">
			<table border="0" cellspacing="0" cellpadding="0" width="670">
			<tr><td height="20"></td></tr>
			<tr><td height="1" bgcolor="#E7D2D1"></td></tr>
			<tr>
				<td height="40" bgcolor="#F5F1F2" align="center" style="padding:40 40;">
					죄송합니다. 결제가 완료되지 않았습니다.<br>
				<font class="orange_b">결제실패코드 : 사용자 취소</font><br>
				<font class="orange">다시 시도해 주십시오.</font></td>
				</td>
			</tr>
			<tr><td height="1" bgcolor="#E7D2D1"></td></tr>
			<tr>
				<td align="right" style="padding:10 0 0 0;">
					<a href="javascript:goList();"><img src="http://file.isky.co.kr/images/shop/common/bttn_confirm.gif" align="absmiddle"></a>
				</td>
			</tr>
			</table>
			</td>
