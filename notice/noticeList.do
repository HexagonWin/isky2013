...
jQuery(function(){
	...
	jQuery("input[name='strcode'], input[name='search_value']").bind("change",function(){
		...
		<div id="container">
			<div class="location">
				<a href="#">HOME</a><em>공지사항</em>
			</div>

			<h2 class="pageTitA"><img src="../../img/contents/notice/tit_notice.gif" alt="공지사항" /></h2>
			<p class="descA">
				서비스 및 운영과 관련하여 <strong class="fcPurple">다양한 정보</strong>를 안내 합니다.
			</p>

			<div class="searchBar">
			<form name="frm1" id="frm1" method="POST" onsubmit="return check_search();">
			
				<div class="select fl" style="width:120px;">
					<span class="arrow"></span>
					<div class="myValue"></div>
					<ul class="iList" id="cateList">
						<li><input type="radio" name="strcode" id="sort0" class="option" value="" checked=checked /><label for="sort0">전체</label></li>
					
					
						<li><input type="radio" name="strcode" id="sort1" class="option" value="30005" /><label for="sort1">공통</label></li>
						
					
						<li><input type="radio" name="strcode" id="sort2" class="option" value="30007" /><label for="sort2">S/W 업데이트</label></li>
