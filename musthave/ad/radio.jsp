...
<input type="hidden" name="top_url" value="/musthave/ad/radio.jsp">
...
<script>var dispNum="010203"</script>
...
<script language=javascript>
	function goView(idx){
		radioPlayerFrm.location.href = "radio_iframe.jsp?idx="+idx;
	}
</script>
</head>
<body scroll="no" onLoad="javascript:goView('101');">
		...
		<td class="subLeft"><div id='content'><div id='mycustomscroll' class='flexcroll'>
			<table width="760" cellpadding="0" cellspacing="0" border="0">
				...
				<tr valign="top">
					...
					<td width="150" class="subNavi"><script>swftrans('/static/flash/subNavi_0102.swf?PageCode=010203', '135', '130');</script><!-- <img src="/static/flash/subNavi_01.gif"> --></td>
					...
					<table width="" cellpadding="0" cellspacing="0" border="0">
						<tr valign="top">
							<td class="p30b"><iframe src="radio_iframe.jsp" width="610" height="39" id="radioPlayerFrm" name="radioPlayerFrm" frameborder="0"></iframe> </td>
						</tr>
					</table>
					<table width="610" cellpadding="0" cellspacing="0" border="0" class="tbl_boardList01">
						<col width="70">
						<col width="420">
						<col width="120">
						<tr align="center">
							<th height="26" class="left"><img src="/static/images/musthave/boardTh_no.gif"></th>
							<th><img src="/static/images/musthave/boardTh_title.gif"></th>
							<th class="right"><img src="/static/images/musthave/boardTh_listen.gif"></th>
						</tr>
						<!-- [s] 반복 -->
						
						<tr align="center" valign="top">
							<td>10</td>
							<td class="title" align="left">MUST HAVE_2월29일</td>
							<td class="button"><a href="javascript:goView('101');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>9</td>
							<td class="title" align="left">MUST HAVE_봄바람</td>
							<td class="button"><a href="javascript:goView('81');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>8</td>
							<td class="title" align="left">MUST HAVE_새해계획</td>
							<td class="button"><a href="javascript:goView('46');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>7</td>
							<td class="title" align="left">MUST HAVE_지금</td>
							<td class="button"><a href="javascript:goView('45');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>6</td>
							<td class="title" align="left">MUST HAVE_나의 반쪽</td>
							<td class="button"><a href="javascript:goView('44');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>5</td>
							<td class="title" align="left">MUST HAVE_열린생각</td>
							<td class="button"><a href="javascript:goView('43');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>4</td>
							<td class="title" align="left">MUST HAVE_감각</td>
							<td class="button"><a href="javascript:goView('42');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>3</td>
							<td class="title" align="left">MUST HAVE_여행</td>
							<td class="button"><a href="javascript:goView('41');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>2</td>
							<td class="title" align="left">MUST HAVE_매력</td>
							<td class="button"><a href="javascript:goView('24');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
						
						<tr align="center" valign="top">
							<td>1</td>
							<td class="title" align="left">MUST HAVE_유머</td>
							<td class="button"><a href="javascript:goView('1');"><img src="/static/images/musthave/btn_listenAd.gif" border="0"></a></td>
						</tr>
					...
					<table width="610" cellpadding="0" cellspacing="0" border="0" class="tbl_paging">
						<tr valign="top">
							<td align="center">
								<img src='/static/images/musthave/btn_paging_prev.gif' border='0' align='absmiddle'><b>1</b>&nbsp;<img src='/static/images/musthave/btn_paging_next.gif' border='0' align='absmiddle'>
...
refurl_url = "/musthave/ad/radio.jsp";
refurl_param = "";
