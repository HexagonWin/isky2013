...
<input type="hidden" name="top_url" value="/musthave/ad/tv.jsp">
...
<script>
	...
	function goProduct(form, s_no){
		alert("Á¦Ç° »ó¼¼ ÆäÀÌÁö ¸µÅ©¸¦ °É¾î ÁÖ¼¼¿ä.");
		//location.href = "";
	}
...
A.a_Location { font: 11px/14px "µ¸¿ò"; color:#bed3ea ; text-decoration: none; }
A:hover.a_Location { font: 11px/14px "µ¸¿ò" ; color:#bed3ea ; text-decoration: none;}
...
.subLeft {border-right:solid 10px #FFFFFF;background:#679bd2 url('/static/images/common/contBg_01.gif') 0 0 repeat-x;}
...
A.a_board01 { font: 12px/18px "µ¸¿ò"; color:#333333 ; text-decoration: none; }
A:hover.a_board01 { font: 12px/18px "µ¸¿ò" ; color:#333333 ; text-decoration: none;}
		...
		<td class="subLeft"><div id='content'><div id='mycustomscroll' class='flexcroll'>
			<table width="760" cellpadding="0" cellspacing="0" border="0">
				...
				<tr valign="top">
					...
					<table width="610" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad">
						<!-- [s] ¹Ýº¹ -->
						<tr valign='top' align='center'>

							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-S240K</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, '78VLrWG0YsY~DazVg/sZV/k~');"><img src="http://file.isky.co.kr/upload/advertising_tv/s240k_163-132(1).jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-U220 / IM-U220K</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
									<img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_1.gif">
									</td>
								</tr>
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'da0ircHFfag~S0Wh65mMbAw~');"><img src="http://file.isky.co.kr/upload/advertising_tv/U220(K)_163-132.jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-U200</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'fQcLsgqO1BU~5koVWd0wXcI~');"><img src="http://file.isky.co.kr/upload/advertising_tv/shootin_star_163-132(3).jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
						</tr>
<tr valign='top' align='center'>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-S230</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'pEn/sUolk58~yWPhkDhX6_A~');"><img src="http://file.isky.co.kr/upload/advertising_tv/070622_s230_½æ³×ÀÏimg(0).jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-R200 / IM-R200K</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'drW_sSllK5U~GH0fv9i0TFo~');"><img src="http://file.isky.co.kr/upload/advertising_tv/IM-R200(163x132)(2).jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-U170</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'OdVusmqIAIM~xlK5tqUPyAg~');"><img src="http://file.isky.co.kr/upload/advertising_tv/u170_01_thumb(0).jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
						</tr>
<tr valign='top' align='center'>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-U150 / U150L</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'vrxFssqZG2U~z4XThBAnFmk~');"><img src="http://file.isky.co.kr/upload/advertising_tv/thumbnail(0).jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-U160 / U160K / ...</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
								...
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, '4SlPsQgCvrE~XbJXKUntwOw~');"><img src="http://file.isky.co.kr/upload/advertising_tv/boom.jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
							...
							<td width="204" class="cell"><table width="165" cellpadding="0" cellspacing="0" border="0" class="tbl_tvad_thumb">
								<tr valign="top">
									<th width="55" class="tit">Á¦Ç°¸í</th>
									<td width="110" class="txt">IM-S130 / S130K</td>
								</tr>
								<tr>
									<th class="tit">Æò±Õº°Á¡</th>
									<td class="txt">
									<img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_0.gif"><img src="/static/images/musthave/star_1.gif"><img src="/static/images/musthave/star_1.gif">
									</td>
								</tr>
								<tr valign="top">
									<td colspan="2" class="thumb"><a href="javascript:goView(iForm, 'Go09sejkW4A~FuJuwlpN07M~');"><img src="http://file.isky.co.kr/upload/advertising_tv/slim_big.jpg" class="tvad_thumb" width="163" height="132" border="0"></a></td>
								</tr>
							</table></td>
						</tr>
					...
					<table width="610" cellpadding="0" cellspacing="0" border="0" class="tbl_paging">
						<tr valign="top">
							<td align="center">
								<img src='/static/images/musthave/btn_paging_prev.gif' border='0' align='absmiddle'><b>1</b>&nbsp;&nbsp;&nbsp;<a href=tv.jsp?page=2&s_kind=&s_value=&s_type=>2</a>&nbsp;<img src='/static/images/musthave/btn_paging_next.gif' border='0' align='absmiddle'>
