...
<input type="hidden" name="top_url" value="/mypage/point/point1.jsp">
...
<SCRIPT language="javascript">
	window.onload = init;
	function init () {
		parent.document.getElementById('If_IPoint1').height = document.body.scrollHeight;
	...
	<tr valign="top">
		<td xclass="subLeft" style='background-color:#58acb9;'>
					...
					<table width="610" cellpadding="0" cellspacing="0" border="0">
						<tr valign="top">
							<td><img src="/static/images/mypage/070302_box_01.gif"></td>
						</tr>
						<tr>
							<td style="background:url('/static/images/mypage/070302_box_02.gif') repeat-y;padding:10px 0 13px 17px;"><table width="" cellpadding="0" cellspacing="1" border="0" class="tbl_playdetail">
								<tr>
									<td width="129" height="23"><img src="/static/images/mypage/070302_tit_01.gif"></td>
									<td width="82" class="box">0</td>
									<td width="88" class="white">원</td>
									<td width="125"><img src="/static/images/mypage/070302_tit_02.gif"></td>
									<td width="82" class="box">0</td>
									<td class="white">원</td>
								</tr>
							</table></td>
						...
						<tr valign="top">
							<td><img src="/static/images/mypage/070302_box_03.gif"></td>
						</tr>
					</table>
					<table width="610" cellpadding="0" cellspacing="0" border="0" class="tbl_btn">
						<tr valign="top">
							<td align="right"><a href="javascript:pop('http://www.isky.co.kr/mypage/pop_mobilecash.jsp','PMobileCash',340,214)"><img src="/static/images/mypage/btn_mcashEx.gif" border="0"></a></td>
						</tr>
					</table>
					<!-- [e] 적립금상세내역 -->
					<!-- [s] 적립금지급내역조회 -->
					<table width="610" cellpadding="0" cellspacing="0" border="0" style="margin-top:25px;">
						<tr valign="top">
							<td class="p10b"><img src="/static/images/mypage/070302_stit_01.gif"></td>
						</tr>
					</table>
					<table width="610" cellpadding="0" cellspacing="0" border="0">
						<tr valign="top">
						...
						<tr valign="top">
							<td style="background:url('/static/images/mypage/070302_box2_02.gif') repeat-y;padding:9px 0;"><table width="605" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									<td style="padding:0 0 0 10px;"><select name="sYYYY" style="xbehavior:url('/static/css/selectbox.htc'); width:55px;">
									...
									<select  onChange="change(frmMain.sYYYY.value,frmMain.sMM.value,'',frmMain.sDD)" name="sMM" style="xbehavior:url('/static/css/selectbox.htc'); width:55px;">
										<option value="">--</option>
									...
									<select name="sDD" style="xbehavior:url('/static/css/selectbox.htc'); width:55px;">
										<option value="">--</option>
									</select>일 ~
									<select  name="eYYYY" style="xbehavior:url('/static/css/selectbox.htc'); width:55px;">
									...
									<select onChange="change(frmMain.eYYYY.value,frmMain.eMM.value,'',frmMain.eDD)" name="eMM" style="xbehavior:url('/static/css/selectbox.htc'); width:55px;">
										<option value="">--</option>
										<option value="01" selected>01</option>
										<option value="02" >02</option>
										<option value="03" >03</option>
									...
									<select name="eDD" style="xbehavior:url('/static/css/selectbox.htc'); width:55px;">
										<option  value="">--</option>
									</select>일
						...
						<tr valign="top">
							<td class="p7b"><table width="" cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td style="padding-top:2px;"><!--2007.10.10 ~ 2007.10.17-->2009.01.23~2009.01.30</td>
								</tr>
							</table></td>
						</tr>
					</table>
					<table width="610" cellpadding="0" cellspacing="0" border="0" class="tbl_boardList07">
						...
						<tr align="center">
							...
							<th><img src="/static/images/mypage/boardTh_price.gif"></th>
							<th class="right"><img src="/static/images/mypage/boardTh_reserve.gif"></th>
						</tr>

						<tr align="center">
							<td height="40" class="c_f" colspan="4">조회결과가 없습니다.</td>
						</tr>
