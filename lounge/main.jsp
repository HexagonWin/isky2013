...
<input type="hidden" name="top_url" value="/lounge/main.jsp">
...
<script>var dispNum="04"</script>
<script>
	function goKHView(form, idx){
		form.action = "/lounge/knowhow/knowhow_view.jsp";
		form.idx.value = idx;
		form.submit();
	}
</script>
...
.fdTab2 {background:url('/static/images/lounge/_tabBg.gif') repeat-x;padding:0 0 0 10px;}
	...
	<tr valign="top">
		<td class="subLeft"><div id='content'><div id='mycustomscroll' class='flexcroll'>
			<table width="760" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td><img src="/static/images/lounge/main2/04_visual.gif"></td>
				</tr>

				<tr>
					<td style="padding:0 0 0 60px;"><table width="670" cellpadding="0" cellspacing="0" border="0">
						<tr valign="top">
							<!-- [s] 솔직담백 -->
							<td width="355"><table width="315" cellpadding="0" cellspacing="0" border="0">
								<tr valign="top">
									<td><a href="javascript:menuLink('0401');"><img src="/static/images/lounge/main2/04_stit_01.gif" border="0"></a></td>
								</tr>
								<tr valign="top">
									<td height="137" style="padding:8px 0 0 0;"><table width="314" cellpadding="0" cellspacing="0" border="0">
										<tr valign="top" align="center">


												
											<td width="155"><table cellpadding="0" cellspacing="0" border="0">
												<tr valign="top">
													<td  class="uccListThumb" align='center' valign="middle" width="123" height="82"><a href='/lounge/review/product_view.jsp?num=701' class='a_lounge'><img src='http://file.isky.co.kr/upload/isky_phone/59_IM-U210K_m.gif' border='0'  ></a></td>
												</tr>
												<tr valign="top">
													<td align="center" class="p5t"><b>[일반]</b>IM-U210K</td>
												</tr>
											</table></td>
<td><img src='/static/images/lounge/main2/vline.gif'></td>
												
											<td width="155"><table cellpadding="0" cellspacing="0" border="0">
												<tr valign="top">
													<td  class="uccListThumb" align='center' valign="middle" width="123" height="82"><a href='/lounge/review/product_view.jsp?num=4' class='a_lounge'><img src='http://file.isky.co.kr/upload/leader_exp/s300review0(5).jpg' border='0'  width='123' height='80'></a></td>
												</tr>
												<tr valign="top">
													<td align="center" class="p5t"><b>[전문가]</b>IM-S300</td>
												</tr>
											</table></td>
							...
							<td width="315"><table width="315" cellpadding="0" cellspacing="0" border="0">
								<tr valign="top">
									<td><a href="javascript:menuLink('0403');"><img src="/static/images/lounge/main2/04_stit_02.gif" border="0"></a></td>
								</tr>

								<tr valign="top">
									<td style="padding-top:8px;"><table width="" cellpadding="0" cellspacing="0" border="0">
										<tr valign="top">
<td width='50'><img src='http://file.isky.co.kr/upload/isky_phone/63_IM-240K_m.gif'></td>

			<td><table width="250" cellpadding="0" cellspacing="0" border="0">


												<tr>
													<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/leader/experience_pre_view.jsp?msgid=0yTXeHplGzE~QmfDfPu1S2k~">넌 어느별에서 왔니?</a></td>
												</tr>

												<tr>
													<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/leader/experience_pre_view.jsp?msgid=qWWBeVvUz2M~B3obuhMeXxA~">스카이 im-U200 슈팅스타 - 외관 둘러보기</a></td>
												</tr>

												<tr>
													<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/leader/experience_pre_view.jsp?msgid=HCxeeRuaCwE~d_Kpcnf2bGU~">IM-U200 슈팅스타와 시작하는 첫번째 체험기~★</a></td>
												</tr>

												<tr>
													<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/leader/experience_pre_view.jsp?msgid=CQtkeXtOLLw~V2MKKONF0Fw~">슈팅스타 디자인 및 인터페이스 소개!</a></td>
												</tr>

												<tr>
													<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/leader/experience_pre_view.jsp?msgid=e9FAeTsUaFk~Udf9LhTLdeg~">[SKY]_슈팅스타 IM-U200 (개봉기&디자인)</a></td>
												</tr>
						...
						<tr valign="top">
							<td><table width="" cellpadding="0" cellspacing="0" border="0">
								<tr valign="top">
									<td><a href="javascript:menuLink('0404');"><img src="/static/images/lounge/main2/04_stit_03.gif" border="0"></a></td>
								</tr>
								<tr valign="top">
									<td style="padding-top:8px;"><table width="240" cellpadding="0" cellspacing="0" border="0">




						<tr>
							<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/knowhow/knowhow_view.jsp?idx='tDQveRr3BSg~KbgueDONw8Y~'">레인폰/슬라이드 열지않고 메뉴들어가기</a></td>
						</tr>


						<tr>
							<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/knowhow/knowhow_view.jsp?idx='oRM1eXqrJuM~nHU8mrQN56Q~'">DMB 채널 바로가기</a></td>
						</tr>


						<tr>
							<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/knowhow/knowhow_view.jsp?idx='d/xVeDnlSxw~Lfb7dgxb7pE~'">네비를 이용한 IM-U160 스피커폰</a></td>
						</tr>


						<tr>
							<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/knowhow/knowhow_view.jsp?idx='sF9EeBnI6eo~yNgrvqL2fnM~'">배터리 교체시~</a></td>
						</tr>


						<tr>
							<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/knowhow/knowhow_view.jsp?idx='ih1QeNkwK2E~fFmxbbZ_iBA~'">사진촬영에서 앨범바로들어가기</a></td>
						</tr>
							...
							<td><table width="" cellpadding="0" cellspacing="0" border="0">
								<tr valign="top">
									<td><a href="javascript:menuLink('0402');"><img src="/static/images/lounge/main2/04_stit_04.gif" border="0"></a></td>
								</tr>
								<tr valign="top">
									<td style="padding-top:8px;"><table width="250" cellpadding="0" cellspacing="0" border="0">


										<tr>
											<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/gallery/ucc_view.jsp?page=1&idx=488" class="a_board04">엉터리기계....</a></td>
										</tr>


										<tr>
											<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/gallery/ucc_view.jsp?page=1&idx=487" class="a_board04">ㄴㅌㅌㅊㅌㅌ</a></td>
										</tr>


										<tr>
											<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/gallery/ucc_view.jsp?page=1&idx=486" class="a_board04">깜찍한 리본이 핸드폰과 합체</a></td>
										</tr>


										<tr>
											<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/gallery/ucc_view.jsp?page=1&idx=485" class="a_board04">돌핀 하늘을 날다??</a></td>
										</tr>


										<tr>
											<td height="20"><img src="/static/images/lounge/main2/ico_dot.gif"><a href="/lounge/gallery/ucc_view.jsp?page=1&idx=484" class="a_board04">아트 경지의 오른 레인폰~</a></td>
										</tr>
