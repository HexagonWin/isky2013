...
function detail_go1() {
	opener.contentsIframe.location.href = "/mypage/point/guide.jsp";
	self.close(); 
	}
function detail_go2() {
	opener.contentsIframe.location.href = "/mypage/point/activity.jsp";
	self.close(); 
	}
			...
			<table width="308" height="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td valign="top" class="p20t"><table width="308" cellpadding="0" cellspacing="0" border="0">
						<tr valign="top">
							<td><img src="/static/images/popup/20090224/popup.gif" border="0" usemap="#map"></td>
					  </tr>
					</table></td>
				</tr>
