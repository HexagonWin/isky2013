	...
	jQuery(document).ready(function(){
		...
		<div id="container">
			...
			<div class="evtTop">
				<div class="slide">
					<ul id="mainSlide">
							...
							<li>
							<a href="evtView.do?intevent_seq=9512&"><img src='http://file.ivega.co.kr/upload/event/image/1347431964340_13c7c06.jpg' width="475" height="90" alt="[AppsPlay] 지금 제일 잘 나가는 노래 Top7! Vol.9"/></a>
							</li>
						
							<li>
							<a href="evtView.do?intevent_seq=9511&"><img src='http://file.ivega.co.kr/upload/event/image/1347431800090_17hrrf.jpg' width="475" height="90" alt="[AppsPlay] 로맨틱 영화 가격할인 이벤트"/></a>
							</li>
						
							<li>
							<a href="evtView.do?intevent_seq=9509&"><img src='http://file.ivega.co.kr/upload/event/image/1347431293418_1e5ii37.jpg' width="475" height="90" alt="[AppsPlay]지난주 방송 단돈 300원_7"/></a>
							</li>
						
							<li>
							<a href="evtView.do?intevent_seq=9484&"><img src='http://file.ivega.co.kr/upload/event/image/1346918427182_1jm94rln.jpg' width="475" height="90" alt="[AppsPlay] 애니메이션 묶음상품"/></a>
							</li>
						
							<li>
							<a href="evtView.do?intevent_seq=9483&"><img src='http://file.ivega.co.kr/upload/event/image/1346918334479_1ciw127.jpg' width="475" height="90" alt="[AppsPlay] 드라마 패키지"/></a>
							</li>
						
					</ul>
				</div>
				
				<div class="dotP" id="pagination">
					<!--
					<a href="#" class="on">1</a>
			...
			<ul class="evtList">
				...
				<li >
					<a href="evtView.do?intevent_seq=9512&">
						<img src='http://file.ivega.co.kr/upload/event/image/1347431964387_2sofkt.jpg' width="475" height="90" alt="[AppsPlay] 지금 제일 잘 나가는 노래 Top7! Vol.9"/>
						<span class="ico tpC">
							<span>
						...
						<span class="txt">
							<strong>[AppsPlay] 지금 제일 잘 나가는 노래 Top7! Vol.9</strong><br />
							<span class="date">2012.09.12 ~ 2012.09.16</span>
						</span>
					</a>
				</li>
				
				<li class="fr">
					<a href="evtView.do?intevent_seq=9511&">
						<img src='http://file.ivega.co.kr/upload/event/image/1347431800137_212xt9.jpg' width="475" height="90" alt="[AppsPlay] 로맨틱 영화 가격할인 이벤트"/>
						<span class="ico tpC">
							<span>
						...
						<span class="txt">
							<strong>[AppsPlay] 로맨틱 영화 가격할인 이벤트</strong><br />
							<span class="date">2012.09.12 ~ 2012.09.16</span>
						</span>
					</a>
				</li>
				...
				<li >
					<a href="evtView.do?intevent_seq=9509&">
						<img src='http://file.ivega.co.kr/upload/event/image/1347431293481_2985v2.jpg' width="475" height="90" alt="[AppsPlay]지난주 방송 단돈 300원_7"/>
						<span class="ico tpC">
							<span>
						...
						<span class="txt">
							<strong>[AppsPlay]지난주 방송 단돈 300원_7</strong><br />
							<span class="date">2012.09.12 ~ 2012.09.16</span>
						</span>
					</a>
				</li>
				...
				<li >
					<a href="evtView.do?intevent_seq=9483&">
						<img src='http://file.ivega.co.kr/upload/event/image/1346918334557_2rwqddm.jpg' width="475" height="90" alt="[AppsPlay] 드라마 패키지"/>
						<span class="ico tpC">
							<span>
						...
						<span class="txt">
							<strong>[AppsPlay] 드라마 패키지</strong><br />
							<span class="date">2012.08.27 ~ 2012.09.30</span>
						</span>
					</a>
				</li>
