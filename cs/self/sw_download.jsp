...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<table width="650" cellpadding="0" cellspacing="0" border="0" class="tbl_boardList06">
						...
						<tr align="center" valign="top">
							...
							<td>1.0</td>
							<td>KTF</td>
							<td class="button">사용설명서</td>
							<td class="button">
								<a href='javascript:fldown_message("http://dmfile.isky.co.kr/upload/product/usm/User Manual_IM-S410K.zip","USM","446","IM-S410K","");' title="IM-S410K 사용설명서"><img src="/static/images/cs/btn_download.gif" border="0"></a></td>
						</tr>
						...
						<tr align="center" valign="top">
							...
							<td class="button">사용설명서</td>
							<td class="button">
								<a href='javascript:fldown_message("http://dmfile.isky.co.kr/upload/product/usm/User Manual_IM-S410.zip","USM","445","IM-S410","");' title="IM-S410  사용설명서"><img src="/static/images/cs/btn_download.gif" border="0"></a></td>
						</tr>
						...
						<tr align="center" valign="top">
							...
							<td class="button">
								<a href='javascript:fldown_message("http://dmfile.isky.co.kr/upload/product/usb/USB Driver_IM-S410K.zip","USB","444","IM-S410K","");' title="IM-S410K / USB"><img src="/static/images/cs/btn_download.gif" border="0"></a></td>
						</tr>
						...
						<tr align="center" valign="top">
							...
							<td class="button">USB드라이버</td>
							<td class="button">
								<a href='javascript:fldown_message("http://dmfile.isky.co.kr/upload/product/usb/USB Driver_IM-S410.zip","USB","443","IM-S410","");' title="IM-S410 / USB"><img src="/static/images/cs/btn_download.gif" border="0"></a></td>
						</tr>
						...
						<tr align="center" valign="top">
							...
							<td>3.77</td>
							<td>KTF</td>
							<td class="button">데이터매니저 PLUS</td>
							<td class="button">
								<a href='javascript:fldown_message("http://dmfile.isky.co.kr/upload/product/dmf/Datamanager Plus_ver3.77(0).zip","DMP","442","IM-S410K","");' title="IM-S410K / 3.77"><img src="/static/images/cs/btn_download.gif" border="0"></a></td>
						</tr>
