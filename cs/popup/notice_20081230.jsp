...
<script language="JavaScript">
	...
	setCookie( "popup20081230", "done" , 1); //하룻동안 열지 않음
	self.close(); 
    }
</script>
</head>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="border:7px solid #cfd0d2; background-color:#ffffff;">
	<tr>
		<td valign="top" style="padding:15px 9px 0 9px;"><table width="308" height="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="40" valign="top"><img src="/static/images/cs/notice/20081230_pop_title.gif"></td>
			</tr>

			<tr valign="top">
				<td class="p20t"><table width="308" cellpadding="0" cellspacing="0" border="0">
					<tr valign="top">
						<td style="border:solid 1px #c2c2c2;padding:27px 16px;"><img src="/static/images/cs/notice/20081230_pop_txt.gif"></td>
					</tr>
				</table></td>
			</tr>
