...
<SCRIPT LANGUAGE="JavaScript"> 
<!-- 
	window.onload = init; // onload 시 실행

	function init() {
		setTimeout("in_form()",20); // 브라우저에 따라 셀렉트 표시되지 않는 문제 해결 위해 딜레이
	}
	...
	function in_form() {
		...
		d_car += "<option value='24'>IM-R300 계열</option>"; 

		d_car += "<option value='23'>IM-U300 계열</option>"; 

		d_car += "<option value='22'>IM-S300 계열</option>"; 
