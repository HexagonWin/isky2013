...
<html>
	...
	function ClosePopup()
	{  
	    SetCookie("setNotic_MOBILEPopUp01", "no" , 1); // 1일 간 쿠키적용 
	    self.close();			
	}
	...
	<body bgcolor="#C6C6C6" leftmargin="0" topmargin="0">
		<form name="Form1" method="post" action="mobilePopup.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwyNTUzNTMzNDI7Oz4=" />
			...
			<table width="320" border="0" cellpadding="0" cellspacing="0" bgcolor="#C6C6C6">
				<tr>
					<td valign="top"><img src="http://file.isky.co.kr/images/event/popup/20051005_mobile.jpg" border="0"></td>
				</tr>
				<tr>
