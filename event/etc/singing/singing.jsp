...
function popEvent1() {
	...
	screen_height= screen.availHeight - 30;
//	alert(screen_width);
//	alert(screen_height);

	if(screen_width > 1150){
		popCwin('http://www.isky.co.kr/event/etc/singing/popFlash.jsp', 'singinginthesky', '1150', '780','no');
	}

	if(screen_width < 1150){
//		alert(screen_width);
		top.window.moveTo(0,0);
		popMusical('http://www.isky.co.kr/event/etc/singing/popFlash.jsp', 'singinginthesky', screen_width, screen_height,'no');
	}
}
</script>
...
A.a_Location { font: 11px/14px "µ¸¿ò"; color:#b8dbe0 ; text-decoration: none; }
A:hover.a_Location { font: 11px/14px "µ¸¿ò" ; color:#b8dbe0 ; text-decoration: none;}
...
.subLeft {border-right:solid 10px #FFFFFF;background:#58acb9 url('/static/images/common/contBg_07.gif') 0 0 repeat-x;}
...
.fdTab {background:url('/static/images/mypage/_tabBg.gif') repeat-x;padding:0 0 0 10px;}
.fdTab2 {background:url('/static/images/mypage/_tabBg.gif') repeat-x;padding:0 0 0 10px;}

A.a_board07 { font: 12px/18px "µ¸¿ò"; color:#333333 ; text-decoration: none; }
A:hover.a_board07 { font: 12px/18px "µ¸¿ò" ; color:#333333 ; text-decoration: none;}

</style>
</head>
<body scroll="no" onload="javascript:popEvent1();">
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top">
		<td class="subLeft" style="background:#479c95 url('/static/images/event/etc/singing/bodyBg.jpg') repeat-x;"><div style="position:relative;width:759px;"><div style="position:absolute;left:315px;"><img src="/static/images/event/etc/singing/logo.jpg"></div></div>
			<table width="760" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr valign="middle">
					<td><img src="/static/images/event/etc/singing/gate.jpg" border="0" usemap="#Map"></td>
				</tr>
			</table>
			</td>
...
refurl_url = "/event/etc/singing/singing.jsp";
refurl_param = "";
...
<map name="Map">
	<area shape="circle" coords="661,216,24" href="javascript:popEvent1();" onfocus="javascript:this.blur();">
</map>
</body>
</html>
