...
<HTML>
	...
	<body>
		<Meta_Title value="사용자 회원혜택안내" />
		<Meta_From value="USER" />
		<Meta_Path value="Home:멤버십:회원혜택안내" />
		<form name="member" method="post" action="MemberGuid.aspx" id="member">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTI1NzYzOTcwMjs7Pg==" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_member_in.swf?code=U1" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_member_in.swf?code=U1" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fmember%2fMemberGuid.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fmember%2fMemberGuid.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
									...
									<td>
										<DIV class="CONTENTS">
											...
											<DIV class="LINEMAP"><a href="/" class="gray">Home</a> &gt;&nbsp;<a href="./MemberGuid.aspx" class="gray">멤버십</a>
												&gt; 회원혜택안내</DIV>
											<IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_title.gif"><BR>
											<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" CLASS="BD2">
												<TR>
													<TD><IMG SRC="http://file.isky.co.kr/images/user/member/member_favor_title_txt.gif"></TD>
													<TD ALIGN="right"><IMG SRC="http://file.isky.co.kr/images/user/member/member_favor_title_illust.gif"></TD>
												</TR>
											</TABLE>
											<BR>
											<TABLE CELLPADDING="0" CELLSPACING="0" STYLE="WIDTH:690px">
												<COLGROUP>
													<COL WIDTH="115">
													<TR>
														<TD><IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_img_01.jpg"></TD>
														<TD><IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_title_01.gif" STYLE="MARGIN-BOTTOM:9px"><BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															SKY 제품 정보 등록 시 정회원으로 등급 전환됩니다.<BR>
															<IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" ALIGN="absMiddle">
															제품사용기 작성 및 중고장터 팔기등록은 SKY&nbsp;제품등록을 하신 정회원만 사용 가능합니다.
														</TD>
													</TR>
													<TR STYLE="PADDING-TOP:20px">
														<TD><IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_img_02.jpg"></TD>
														<TD><IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_title_02.gif" STYLE="MARGIN-BOTTOM:9px"><BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															1000 포인트를 지급해 드립니다.<BR>
															&nbsp;&nbsp;&nbsp; (포인트는 모바일컨텐츠 다운로드, 문자 전송, 액세서리구매, 사진인화 신청시 사용할 수 있습니다)<BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															5000 지수 도달 시 매니아 회원으로 등급 전환 심사가 신청됩니다.&nbsp;<BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															문자 전송시 20 포인트로 사용 가능합니다.&nbsp;
														</TD>
													</TR>
													<TR STYLE="PADDING-TOP:20px">
														<TD><IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_img_03.jpg"></TD>
														<TD><IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_title_03.gif" STYLE="MARGIN-BOTTOM:9px">&nbsp;<BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															매니아 등급심사에서 승인되신 분들은 10000 포인트를 지급해 드립니다.<BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															매니아분들을 대상으로 비정기적인 이벤트 실시 및 오프라인 행사 시 지원해드립니다.<BR>
															<IMG SRC="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" ALIGN="absMiddle">
															매니아만의 공간인 매니아 포럼에서 활동하실 수 있습니다<BR>
															<IMG src="http://file.isky.co.kr/images/user/member/mem_favor_bullet.gif" align=absMiddle>
															모바일 컨텐츠 다운로드시 10% 할인 혜택과 문자 전송시&nbsp;20 포인트로 사용 가능합니다.&nbsp;<BR>
														</TD>
													</TR>
													<tr>
														<td colspan="3">
