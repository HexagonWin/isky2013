...
border=0> <map name="Map">
		...
		<BR>
		<DIV id="POPUP">
			<DIV style="PADDING-BOTTOM: 10px; MARGIN-LEFT: 10px">고객님의 정보를 입력해 주시면 확인하여 
				연락드리겠습니다.<BR>
			</DIV>
...
<SCRIPT language="Javascript">
<!--
var SSOBJ_1 = SELECT("<SELECT ID='SS_1' NAME='SS_1' STYLE='WIDTH:100PX;' onchange=SelectScriptSelect1('SS_1')><OPTION VALUE=''>선택하세요</OPTION><OPTION VALUE='IM-S100'>IM-S100 계열</OPTION><OPTION VALUE='IM-U100'>IM-U100 계열</OPTION><OPTION VALUE='IMB-1000'>IMB-1000 계열</OPTION><OPTION VALUE='IM-8000'>IM-8000 계열</OPTION><OPTION VALUE='IM-7000'>IM-7000 계열</OPTION><OPTION VALUE='IM-700'>IM-700 계열</OPTION><OPTION VALUE='IM-6000'>IM-6000 계열</OPTION><OPTION VALUE='IM-5000'>IM-5000 계열</OPTION><OPTION VALUE='IM-3000'>IM-3000 계열</OPTION><OPTION VALUE='IM-2000'>IM-2000 계열</OPTION><OPTION VALUE='IM-1000'>IM-1000 계열</OPTION></SELECT>", 'SS_1', '10');
var SelFlag1 = false;
...
<SCRIPT language="Javascript">
<!--
var SSOBJ_6 = SELECT("<SELECT ID='SS_6' NAME='SS_6' STYLE='WIDTH:80PX;' onchange=SelectScriptSelect6('SS_6')><OPTION VALUE='' selected>직접입력</OPTION><OPTION VALUE='yahoo.co.kr'>야후</OPTION><OPTION VALUE='nate.com'>네이트</OPTION><OPTION VALUE='naver.com'>네이버</OPTION><OPTION VALUE='paran.com'>파란</OPTION><OPTION VALUE='dreamwiz.com'>드림위즈</OPTION><OPTION VALUE='freechal.com'>프리첼</OPTION><OPTION VALUE='netian.com'>넷티앙</OPTION><OPTION VALUE='korea.com'>코리아닷컴</OPTION><OPTION VALUE='orgio.net'>오르지오</OPTION><OPTION VALUE='empal.com'>엠팔</OPTION><OPTION VALUE='hanafos.com'>하나포스</OPTION><OPTION VALUE='kornet.net'>코넷</OPTION><OPTION VALUE='unitel.co.kr'>유니텔</OPTION><OPTION VALUE='nownuri.net'>나우누리</OPTION><OPTION VALUE='chollian.net'>천리안</OPTION><OPTION VALUE='lycos.co.kr'>라이코스</OPTION><OPTION VALUE='msn.co.kr'>MSN</OPTION></SELECT>", 'SS_6', '4');
var SelFlag6 = false;
