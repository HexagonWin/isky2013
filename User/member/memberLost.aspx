...
type=TEXT/CSS rel=STYLESHEET>
		...
		function Checkvalue(_value)
		{
			...
			if(_value == 1)
			{
				if(fm.txt_username1.value.length == 0)
				{
					alert("이름을 입력하셔야 합니다.");
					fm.txt_username1.focus();
					return false;
				}
			...
			{
				if(fm.txt_username2.value.length == 0)
				{
					alert("이름을 입력하셔야 합니다.");
					fm.txt_username2.focus();
					return false;
				}
				...
				if(!checklength(6,document.member.txt_jumin3))
				{
					return false;
				}
				if(!checklength(7,document.member.txt_jumin4))
				{
					return false;
				}
			}
		...
		function Openwin()
		{
			window.open('./MemberLostIDPWD.aspx','lostidpwd','WIDTH=400,HEIGHT=400');
		}
		</script>
	</HEAD>
	<body>
		<Meta_Title value="아이디 비밀번호 찾기" />
		<Meta_From value="isky" />
		<Meta_Path value="Home:멤버십:아이디/비밀번호찾기" />
		<div 
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fmember%2fmemberLost.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fmember%2fmemberLost.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
							...
							<table cellSpacing="0" cellPadding="0" width="728" border="0">
								<tr>
									<td>
										<DIV class="CONTENTS">
											<!--내용들어가는 곳//-->
											<form name="member" method="post" action="memberLost.aspx" id="member">
<input type="hidden" name="__VIEWSTATE" value="" />

												<DIV class="LINEMAP"><a href="/" class=gray>Home</a> &gt;&nbsp;<a href="./MemberGuid.aspx" class=gray>멤버십</a> &gt; 아이디/비밀번호찾기</DIV>
												<IMG 
            src="http://file.isky.co.kr/images/user/member/mem_idpw_sch_title.gif" 
            ><BR>
												<DIV class="CONTENTS_SUB"><IMG 
            src="http://file.isky.co.kr/images/user/member/mem_idpw_sch_title_txt.gif" 
            ><BR>
													<DIV class="SUB_TT_LINE"></DIV>
													<IMG 
            src="http://file.isky.co.kr/images/user/member/mem_idpw_sch_title_01.gif" 
            ><BR>
														...
														<TABLE cellSpacing="0" cellPadding="0">
															<COLGROUP>
																...
																<TBODY>
																	<TR>
																		<TD><IMG 
                  src="http://file.isky.co.kr/images/user/member/tab_name.gif" 
                  align=absMiddle></TD>
																		<TD>
																			<!--이름--><input name="txt_username1" type="text" maxlength="20" id="txt_username1" /></TD>
																	</TR>
																	<TR>
																	...
																	<TR>
																		<TD><IMG 
                  src="http://file.isky.co.kr/images/user/member/tab_pnum.gif" 
                  align=absMiddle></TD>
																		<TD>
																			<!--주민1--><input name="txt_jumin1" type="text" maxlength="6" id="txt_jumin1" onKeyup="NextForm(6,this,txt_jumin2);" /><SPAN class="GRAY_RIGHT">-</SPAN>
																			<!--주민2--><input name="txt_jumin2" type="text" maxlength="7" id="txt_jumin2" onKeyup="NextForm(7,this,'1');" />
																			<input type="image" name="ibtn_searchID" id="ibtn_searchID" onclick="return Checkvalue(1)" src="http://file.isky.co.kr/images/user/member/button_confirm.gif" alt="" align="AbsMiddle" border="0" style="BORDER-RIGHT:0px;BORDER-TOP:0px;BORDER-LEFT:0px;BORDER-BOTTOM:0px" /><A href="#"></A><BR>
																		</TD>
																	</TR>
															</COLGROUP>
														</TABLE>
													...
													<IMG 
            src="http://file.isky.co.kr/images/user/member/mem_idpw_sch_title_02.gif" 
            ><BR>
													<TABLE height="1" cellSpacing="0" cellPadding="0" width="100%" bgColor="#e6e6e6">
														<TR>
															<TD></TD>
                  ...
                  align=absMiddle></TD>
																		<TD>
																			<!--이름--><input name="txt_username2" type="text" maxlength="20" id="txt_username2" /></TD>
																	</TR>
																	<TR>
																		<TD colSpan="2" height="7"></TD>
																	</TR>
																	<TR>
																		<TD><IMG 
                  src="http://file.isky.co.kr/images/user/member/tab_id.gif" 
                  align=absMiddle></TD>
																		<TD>
																			<!--아이디--><input name="txt_userID" type="text" maxlength="12" id="txt_userID" /></TD>
																	</TR>
																	<TR>
																		<TD colSpan="2" height="7"></TD>
																	</TR>
                  ...
                  align=absMiddle></TD>
																		<TD>
																			<!--주민1--><input name="txt_jumin3" type="text" maxlength="6" id="txt_jumin3" onKeyup="NextForm(6,this,txt_jumin4);" /><SPAN class="GRAY_RIGHT">-</SPAN>
																			<!--주민2--><input name="txt_jumin4" type="text" maxlength="7" id="txt_jumin4" onKeyup="NextForm(7,this,'1');" />
																			<input type="image" name="ibtn_searchIDPWD" id="ibtn_searchIDPWD" onclick="return Checkvalue(2)" src="http://file.isky.co.kr/images/user/member/button_confirm.gif" alt="" align="AbsMiddle" border="0" style="BORDER-RIGHT:0px;BORDER-TOP:0px;BORDER-LEFT:0px;BORDER-BOTTOM:0px" /><BR>
																		</TD>
																	</TR>
															</COLGROUP>
				</TBODY>
			...
			<BR>
			<IMG 
            src="http://file.isky.co.kr/images/user/member/mem_idpw_sch_img_01.gif" 
             onclick="Openwin();" style=cursor:hand;></div>
		</DIV></form>
...
<SCRIPT language=JavaScript src="http://file.isky.co.kr/js/AceCounterRun.js"></SCRIPT></td>
		...
		<!-- 하단 --> </DIV></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></DIV>
	</body>
</HTML>
