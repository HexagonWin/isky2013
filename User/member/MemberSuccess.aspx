...
<HTML>
	<HEAD>
		...
		<script>
			function jsUnload(){
				jsPopUpLogin('');
				window.location.href = "http://www.isky.co.kr";
			}	
		</script>
	</HEAD>
	<body onunLoad="jsUnload();">
		<Meta_Title value="회원가입완료" />
		<Meta_From value="isky" />
		<Meta_Path value="Home:멤버십:회원가입완료" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fmember%2fMemberSuccess.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fmember%2fMemberSuccess.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
						...
						<table cellSpacing="0" cellPadding="0" width="728" border="0">
							<tr>
								<td>
									<DIV class="CONTENTS">
										<!--내용들어가는 곳//-->
										<form name="member" method="post" action="MemberSuccess.aspx" id="member">
<input type="hidden" name="__VIEWSTATE" value="dDw1MjMwODQ2MDE7dDw7bDxpPDI+Oz47bDx0PDtsPGk8MD47aTwxPjs+O2w8dDxwPGw8VmlzaWJsZTs+O2w8bzxmPjs+Pjs7Pjt0PDtsPGk8MD47PjtsPHQ8cDxwPGw8VGV4dDs+O2w8XGU7Pj47Pjs7Pjs+Pjs+Pjs+Pjs+" />
											...
											<DIV id="div2" class="CONTENTS_SUB">
												<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="671" HEIGHT="185" BACKGROUND="http://file.isky.co.kr/images/user/member//mem_reg_com_bg_foreign.gif">
													<TR>
														<TD VALIGN="top" STYLE="PADDING-LEFT:185px; PADDING-TOP:67px">
															<B CLASS="RED_DARK">
																<span id="lbl_fname"></span></B>님의 외국인 회원가입 신청이 
															성공적으로 이루어졌습니다.<BR>
															회원가입 승인 결과는 메일로 발송됩니다.
															<BR>
															<IMG SRC="http://file.isky.co.kr/images/com/spacer.gif" WIDTH="1" HEIGHT="44"><BR>
															<A HREF="javascript:jsUnload();"><IMG SRC="http://file.isky.co.kr/images/user/member//button_gomain.gif"></A><BR>
														</TD>
													</TR>
												</TABLE>
											</DIV>
...
<SCRIPT language=JavaScript src="http://file.isky.co.kr/js/AceCounterRun.js"></SCRIPT>
													<input name="emailyn" id="emailyn" type="hidden" value="1" />
												</td>
											</tr>
										</table>
									</DIV>
