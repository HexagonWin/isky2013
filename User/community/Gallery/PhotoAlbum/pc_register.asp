...
<!--
	...
	document.FileManager.InitUploadData("http://file.isky.co.kr/FileSave.aspx", "http://file.isky.co.kr", "/ATT01/2006/ALM/14");
...
<input type=hidden name=img_path value="/ATT01/2006/ALM/14">
