...
<HTML>
	<HEAD>
		...
		<!--
			...
			function goSkyJoin()
			{
				location.href = "/User/userevent/EventIng04.aspx";
			}
		//-->
		</script>
		<script language="JavaScript">
...
//동영상이 안왔을때
//var _theURL = "../../userevent/IndiSKY/beforeplayp.aspx?playid=before";

//동영상이 있을때
var _theURL = "../../userevent/IndiSKY/indiplay_popup.aspx?pfid="+theURL;

var _features = "width=350,height=270,status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=no,copyhistory=no";
  window.open(_theURL,winName,_features);
}
//-->
</script>
	</HEAD>
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		...
		<form name="Form1" method="post" action="SkyLeaderAdieu.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwxMTE3NDQ5OTk4Ozs+" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_community.swf?code=B14" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_community.swf?code=B14" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fCommunity%2fSkyLeader%2fSkyLeaderAdieu.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fCommunity%2fSkyLeader%2fSkyLeaderAdieu.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV CLASS="CONTENTS">
								<DIV CLASS="LINEMAP"><a href='/' class=gray>Home</a> &gt; <a href='/user/community/CommunityMain.aspx' class=gray>
									...
									&gt; SKY리더 송년의 밤</DIV>
								<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_adieu.gif">
								<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
									<TR STYLE="PADDING-BOTTOM:10px">
										<TD><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu01.gif"></TD>
									</TR>
								</TABLE>
              ...
              <TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
                ...
                <TR VALIGN="top" STYLE="PADDING-BOTTOM:20px"> 
                  <TD COLSPAN="3"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu02.gif"></TD>
                </TR>
                <TR VALIGN="top"> 
                  <TD COLSPAN="3"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu03.gif"></TD>
                </TR>
                <TR VALIGN="top"> 
                  <TD colspan="3"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu04.gif" border="0" usemap="#Map"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu05.gif" border="0" usemap="#Map2"></TD>
                </TR>
                <TR VALIGN="top"> 
                  <TD width="57"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu07.gif"></TD>
                  <TD width="451"><iframe src="http://file.isky.co.kr/img_slide.asp" width="579" height="122" frameborder="0" scrolling="no"></iframe></TD>
                  <TD width="57"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu08.gif"></TD>
                </TR>
				<TR VALIGN="top"> 
                  <TD COLSPAN="3"><IMG SRC="http://file.isky.co.kr/images/community/community_modi_leaderadieu09.gif"></TD>
                </TR>
                <!--<TR> 
...
<SCRIPT language=JavaScript src="http://file.isky.co.kr/js/AceCounterRun.js"></SCRIPT></td>
		...
		<map name="Map">
  <area shape="rect" coords="177,83,252,104" href="javascript:MM_openBrWindow('201','indiplay')">
</map>
<map name="Map2">
  <area shape="rect" coords="134,83,208,104" href="javascript:MM_openBrWindow('202','indiplay')">
</map>
	</body>
</HTML>
