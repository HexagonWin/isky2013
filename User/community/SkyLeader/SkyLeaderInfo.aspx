...
<HTML>
	<HEAD>
		...
		<!--
			...
			function goLogin()
			{
				jsPopUpLogin("/user/community/SkyLeader/SkyAzitApplication.aspx");
			}
			
			//스카이 신청 화면으로 이동		
			function goSkyJoin()
			{
				location.href = "/User/userevent/EventIng06.aspx";
			}
		//-->
		</script>
	</HEAD>
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="커뮤니티 SKY리더 소개"></Meta_Title>
		<Meta_From value="isky"></Meta_From>
		<Meta_Path value="커뮤니티:SKY리더:SKY리더소개"></Meta_Path>
		<form name="Form1" method="post" action="SkyLeaderInfo.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTIyMjE2MzI0Mjs7Pg==" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_community.swf?code=B12" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_community.swf?code=B12" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fcommunity%2fSkyLeader%2fSkyLeaderInfo.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fcommunity%2fSkyLeader%2fSkyLeaderInfo.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<!--본문내용 들어가는 곳//-->
							<DIV CLASS="CONTENTS">
								<DIV CLASS="LINEMAP"><a href='/' class=gray>Home</a> &gt; <a href='/user/community/CommunityMain.aspx' class=gray>
										커뮤니티</a> &gt; <a href='/user/community/SkyLeader/SkyExperienceList.aspx' class=gray>SKY 리더</a>
									&gt; SKY 리더 소개</DIV>
								<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title.gif"><BR>
								<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" CLASS="BD2">
									<TR>
										<TD><IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_txt.gif"></TD>
										<TD ALIGN="right"><IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_illust.gif"></TD>
									</TR>
								</TABLE>
								<DIV ID="CONTENTS_SUB" STYLE="PADDING-TOP:10px">
									...
									<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/community/leader_info_img_01.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_01.gif"><BR>
												SKY를 사랑하고 주도적으로 이끌어갈 리더입니다.<BR>
												SKY 리더가 되시면 SKY에서 새롭게 선보이는 최신 핸드폰 단말기의 특별하고 다양한
												<BR>
												기능을 체험하고 활동 과제를 수행하게 됩니다.<BR>
											</TD>
										</TR>
										<TR>
										...
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/community/leader_info_img_02.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_02.gif"><BR>
												SKY&nbsp;리더 활동기간 동안 각 주별로 주어진 활동 과제를 수행하게 됩니다.<BR>
												한달 간 수행한 과제 총점에 따라 차등한 혜택이 제공됩니다.<BR>
												점수는 성실도, 과제 제출 빈도, 기발한 아이디어 등을 기준으로 관리자가 점수를 드립니다.<BR>
											</TD>
										</TR>
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"></TD>
										...
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/community/leader_info_img_03.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_03.gif"><BR>
												<IMG SRC="http://file.isky.co.kr/images/community/bullet_dot.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="7">
												<B>1~10 등</B>까지 : 체험단 활동 시 지급된 단말기 무상 제공<BR>
												<IMG SRC="http://file.isky.co.kr/images/community/bullet_dot.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="7">
												<B>11~20 등</B>까지 : 체험단 활동 시 지급된 단말기를 50% 가격으로 제공 (구입 의사가 없을 시 반납)<BR>
											</TD>
										</TR>
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"></TD>
										...
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/community/leader_info_img_04.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_04.gif"><BR>
												SKY의 최신제품을 사용하실 수 있는 SKY 리더는 신제품 출시 시 본 사이트에서<BR>
												공개모집신청을 받습니다. SKY를 사랑하시는 분은 누구나 신청하실 수 있으며,<BR>
												성실한 신청서를 제출하시는 분 중에 20분을 선정하여 SKY 리더로 선정합니다.<BR>
											</TD>
										</TR>
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"></TD>
										...
										<TR VALIGN="top">
											<TD><IMG SRC="http://file.isky.co.kr/images/community/leader_info_img_05.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/community/leader_info_title_05.gif"><BR>
												SKY 리더들이 수행한 과제중 특별하고 재미있는 내용만 모아 놓은 SKY 리더 체험기에 가시면<BR>
												SKY 리더들이 활동한 글 내용도 볼 수 있고 최신 SKY 단말기 정보도 얻을 수 있습니다.<BR>
											</TD>
										</TR>
									</TABLE>
								</DIV>
