...
<HTML>
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="커뮤니티 SKY강좌 SKY강좌 소개"></Meta_Title>
		<Meta_From value="isky"></Meta_From>
		<Meta_Path value="커뮤니티:SKY강좌:SKY강좌"></Meta_Path>
		<form name="Form1" method="post" action="AcademyInfo.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTk4ODQ5OTMwMjs7Pg==" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_community.swf?code=B32" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_community.swf?code=B32" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fCommunity%2fAcademy%2fAcademyInfo.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fCommunity%2fAcademy%2fAcademyInfo.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV CLASS="CONTENTS">
								...
								<IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_title.gif"><BR>
								<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" CLASS="BD2">
									<TR>
										<TD><IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_title_txt.gif"></TD>
										<TD ALIGN="right"><IMG SRC="http://file.isky.co.kr/images/community/academy_info_title_illust.gif"></TD>
									</TR>
								</TABLE>
								<DIV CLASS="CONTENTS_SUB" STYLE="PADDING-TOP:20px">
									<TABLE CELLPADDING="0" CELLSPACING="0">
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:10px">
											<TD WIDTH="195"><IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_img_01.jpg" HSPACE="8"></TD>
											<TD>
												<IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_txt_01.gif"><BR>
												<A HREF="javascript:goRequest();"><IMG SRC="http://file.isky.co.kr/images/user/community/academy_button_request.gif" HSPACE="10"></A><BR>
											</TD>
										</TR>
									</TABLE>
									<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"><FONT face="굴림">&nbsp;</FONT></TD>
										</TR>
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/user/community/leader_info_img_01.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_title_01.gif"><BR>
												<IMG SRC="http://file.isky.co.kr/images/user/community/bullet_dot.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="7">
												SKY 제품을 자유자재로 활용할 수 있는 회원<BR>
												<IMG SRC="http://file.isky.co.kr/images/user/community/bullet_dot.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="7">
												SKY 제품에 대한 이해가 높은 회원<BR>
												<IMG SRC="http://file.isky.co.kr/images/user/community/bullet_dot.gif" ALIGN="absMiddle" CLASS="BLT" VSPACE="7">
												SKY 제품에 대한 활용 Tip을 쉽게 안내할 자신이 있는 회원<BR>
											</TD>
										</TR>
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"><FONT face="굴림">&nbsp;</FONT></TD>
										...
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/user/community/leader_info_img_02.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_title_02.gif"><BR>
												<IMG class="BLT" src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" align=absMiddle vspace=7> SKY 모델별 기능<BR>
												<IMG class="BLT" src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" align=absMiddle vspace=7> 카메라 100% 활용하기, 데이터 매니저 100% 활용하기, MP3 100% 활용하기, 게임 100% 활용하기, <BR>
                    &nbsp; 숨어 있는 SKY 기능을 찾아라, 휴대폰 요금 최대한 아끼기 등<BR>
											</TD>
										</TR>
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"><FONT face="굴림">&nbsp;</FONT></TD>
										...
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/user/community/leader_info_img_03.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_title_03.gif"><BR>
												<IMG class="BLT" 
            src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" 
            align=absMiddle vspace=7> 강좌운영 신청서 작성<BR>
												<IMG 
            class="BLT" 
            src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" 
            align=absMiddle vspace=7> 운영자와의 전화 상담<BR>
												<IMG 
            class="BLT" 
            src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" 
            align=absMiddle vspace=7> 운영자의 승인<BR>
												<IMG 
            class="BLT" 
            src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" 
            align=absMiddle vspace=7> 강좌 운영 시작<BR>
											</TD>
										</TR>
										<TR>
											<TD COLSPAN="2" BGCOLOR="#e6e6e6"><FONT face="굴림">&nbsp;</FONT></TD>
										...
										<TR VALIGN="top" STYLE="PADDING-BOTTOM:20px">
											<TD><IMG SRC="http://file.isky.co.kr/images/user/community/leader_info_img_04.gif"></TD>
											<TD WIDTH="100%">
												<IMG SRC="http://file.isky.co.kr/images/user/community/academy_info_title_04.gif"><BR>
												<IMG class="BLT" 
            src="http://file.isky.co.kr/images/user/community/bullet_dot.gif" 
            align=absMiddle vspace=7> 강좌 내용과 분량에 따라 3만원, 5만원, 10만원 상당의 상품권을 드립니다.<BR>
											</TD>
										</TR>
									</TABLE>
								</DIV>
