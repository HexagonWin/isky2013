...
<HTML>
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="커뮤니티 매니아클럽 소개"></Meta_Title>
		<Meta_From value="isky"></Meta_From>
		<Meta_Path value="커뮤니티:매니아클럽:매니아소개"></Meta_Path>
		<form name="Form1" method="post" action="ManiaInfo.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDw3NTY0OTMyNjc7Oz4=" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fCommunity%2fMania%2fManiaInfo.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fCommunity%2fMania%2fManiaInfo.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV CLASS="CONTENTS">
								<DIV CLASS="LINEMAP"><a href='/' class="gray">Home</a> &gt; <a href='/user/community/CommunityMain.aspx' class="gray">
										커뮤니티</a> &gt; <a href='/user/community/Mania/ManiaForumList.aspx' class="gray">매니아 
										클럽</a> &gt; 매니아 소개</DIV>
								<IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_title.gif"><BR>
								<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" CLASS="BD2">
									<TR>
										<TD><IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_title_txt.gif"></TD>
										<TD ALIGN="right"><IMG SRC="http://file.isky.co.kr/images/user/community/mania_forum_title_illust.gif"></TD>
									</TR>
								</TABLE>
								<DIV CLASS="CONTENTS_SUB" STYLE="PADDING-TOP:20px">
									<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="670">
										<COLGROUP>
											...
											<TR>
												<TD colspan="2"><IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_st_1.gif"></TD>
												<td rowspan="4"><IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_img.gif"></td>
											</TR>
											<tr>
												<td><IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_icon_1.gif"></td>
												<td>
													<P>
														<span style="COLOR:#9f4e42"><b>5,000지수 획득 후&nbsp;승급심사를 거쳐 승인된 매니아</b></span>의 
														경우<BR>
														SKY 리더 게시판 쓰기를 제외한 모든 컨텐츠를 이용하실 수 있습니다.
														<BR>
														※ 승급심사기준 :&nbsp;획득지수의 히스토리 리뷰를 통해 진행합니다.</FONT></SPAN>
													</P>
												</td>
											</tr>
											<tr>
												<td><IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_icon_2.gif"></td>
												<td>
													<span style="COLOR:#8c5977"><b>SKY 리더로 선정되어 매니아로 등급전환 된 분</b></span>들은<BR>
													SKY 리더를 포함한 모든 컨텐츠를 이용하실 수 있습니다.
												</td>
											</tr>
											<tr>
												<td><IMG SRC="http://file.isky.co.kr/images/user/community/mania_intro_icon_3.gif"></td>
												<td>
													<span style="COLOR:#514480"><b>매니아분</b></span>들은 모바일 컨텐츠 다운로드 시 10%의 할인 혜택과
													<br>
													문자메세지를 20 포인트로 사용 가능합니다.
												</td>
											</tr>
									</TABLE>
									<img SRC="http://file.isky.co.kr/images/user/community/mania_intro_bottom.gif"><BR>
								</DIV>
								<!--본문내용 들어가는 곳//-->
