...
<HTML>
	<HEAD>
		...
		function jsChkInv(){
			tempCount = 0;
			var f = document.f;
			for(i=1;i<=f.strP0.length-1;i++){ 
				if(f.strP0[i].checked){ 
					tempCount ++;
				} 
			} 
			if(tempCount<=3){
				f.strP0[0].checked = false;
			}else if(tempCount == 4){
				f.strP0[0].checked = true;
			}else{
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		...
		<form name="Form1" method="post" action="ProductSearch0.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="dDwxNjE5NTAyNjQwOzs+" />

		</form>
		<form name="f" method="post" action="ProductSearch1.aspx">
			<div 
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fproduct%2fProductSearch0.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fproduct%2fProductSearch0.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV CLASS="CONTENTS">
								...
								<!-- step --> &nbsp; <img src="http://file.isky.co.kr/images/product/search_top_s0.gif">
								<BR>
								...
								<div class="BD" style="PADDING-RIGHT: 15px; PADDING-LEFT: 15px; PADDING-BOTTOM: 5px; WIDTH: 690px; PADDING-TOP: 10px">
									...
									<div style="PADDING-RIGHT: 15px; PADDING-LEFT: 15px; PADDING-BOTTOM: 15px; PADDING-TOP: 15px">
										<input name="strP0" value="SKT" style="WIDTH: 14px; HEIGHT: 14px" class="no" type="checkbox">&nbsp;SKT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input name="strP0" value="KTF" style="WIDTH: 14px; HEIGHT: 14px" class="no" type="checkbox">&nbsp;KTF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input name="strP0" value="LGT" style="WIDTH: 14px; HEIGHT: 14px" class="no" type="checkbox">&nbsp;LGT&nbsp;&nbsp;										 

									</div>
								</div>
								<div style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; WIDTH: 690px; PADDING-TOP: 10px"
									align="right">
									<A href="javascript:GoStep1();"><IMG src="http://file.isky.co.kr/images/user/product/btn_tonext.gif" align="absMiddle"></A>
