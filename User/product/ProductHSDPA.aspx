	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_product.swf?code=D1F" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_product.swf?code=D1F" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fProduct%2fProductHSDPA.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fProduct%2fProductHSDPA.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<!--DWLayoutTable-->
							<tr> 
								<td colspan="2" style="PADDING-BOTTOM : 10px; PADDING-RIGHT : 60px" align="right"><A href="/">Home</A> &gt; <A href="/User/product/ProductMerit.aspx">제품정보 
								</A>&gt; <A href="ProductMerit.aspx?GroupID=IM-H100">IM-H100 Series</A> > <A href="ProductMerit.aspx?PrdID=IM-H100">IM-H100</A> > 제품소개</td>
							</tr>
							<tr>
								<td><IMG src="http://file.isky.co.kr/images/member/info_title_IMH100.gif"></td>
							</tr>
							<tr>
								<td><IMG src="http://file.isky.co.kr/images/member/info_st_IMH100.gif"></td>
							</tr>
							<tr> 
								<td colspan="2" style="PADDING-TOP : 15px"><IMG src="http://file.isky.co.kr/images/member/info_tab_IMH100_01.gif"></td>
							</tr>
							</table>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<!--DWLayoutTable-->
								<tr> 
								<td width="332" rowspan="2" align="center"><textarea id=printflashid style="display:none;" rows="0" cols="0"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="290" height="287">
                    <param name="movie" value="IM-H100.swf">
                    <param name="quality" value="high">
                    <embed src="IM-H100.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="290" height="287"></embed></object></textarea>
												<script language="javascript" src="/embedjs.asp?classid=printflashid"></script></td>
								<td width="336" height="231" valign="top" style="PADDING-LEFT: 5px; PADDING-TOP: 20px;"><img src="http://file.isky.co.kr/images/member/info_subject_IMH100.gif"></td>
								</tr>
								<tr> 
								
                <td height="69" align="right" style="PADDING-RIGHT: 22px"><img src="http://file.isky.co.kr/images/member/info_button_regi_IMH100.gif" style="cursor:hand;" onclick='javascript:loginCheck();'>&nbsp;&nbsp;&nbsp;<a href="../../svc/counsel/CunsFAQH100.aspx"><img src="http://file.isky.co.kr/images/member/info_button_faq_IMH100.gif" border="0"></a></td>
								</tr>
								<tr> 
								<td height="83" colspan="2" style="PADDING-LEFT: 10px"><img src="http://file.isky.co.kr/images/member/info_tab_IMH100_02.gif"></td>
								</tr>
								<tr> 
								<td height="20" colspan="2" style="PADDING-LEFT: 10px"><img src="http://file.isky.co.kr/images/member/info_tab_IMH100_03.gif"></td>
								</tr>
								<tr> 
								<td height="20" colspan="2" style="PADDING-LEFT: 10px"><img src="http://file.isky.co.kr/images/member/info_tab_IMH100_04.gif"></td>
								</tr>
								<tr> 
								<td height="20" align="right" style="PADDING-right: 20px"><a href="JavaScript:"><img src="http://file.isky.co.kr/images/member/screen_icon_download.gif" border="0" onclick="javascript:checkDownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?DOWN_ID=USM&SEQ=1&PRD_ID=IM-H100')"></a></td>
								<td align="right" style="PADDING-right: 50px"><a href="JavaScript:"><img src="http://file.isky.co.kr/images/member/screen_icon_download.gif" border="0" onclick="javascript:JavaScript:checkDownLoadOpen('http://file.isky.co.kr/DownLoad2.aspx?DOWN_ID=USB&SEQ=47')"></a></td>
								</tr>
							</table>
							<br>
							</DIV>
