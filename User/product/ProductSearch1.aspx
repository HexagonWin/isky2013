...
<HTML>
	<HEAD>
		...
		function All_Select(chkVal)
		{
			var f = document.f;
			if(chkVal == false){
				for(i=1;i<=f.strP1.length-1;i++){ 
					f.strP1[i].checked = false;
				} 
			}
			if(chkVal == true){
				for(i=1;i<=f.strP1.length-1;i++){ 
					f.strP1[i].checked = true;
				} 
			}
		}
		...
		function jsChkInv(){
			...
			var f = document.f;
			for(i=1;i<=f.strP1.length-1;i++){ 
				if(f.strP1[i].checked){ 
					tempCount ++;
				} 
			} 
			if(tempCount<=3){
				f.strP1[0].checked = false;
			}else if(tempCount == 4){
				f.strP1[0].checked = true;
			}else{
		...
		{		
			var tempCount = 0;
			var f = document.f;
			f.action = "ProductSearchResult.aspx";
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="제품 검색"></Meta_Title><Meta_From value="isky"></Meta_From><Meta_Path value="Home:제품:제품검색"></Meta_Path>
		<form name="Form1" method="post" action="ProductSearch1.aspx" id="Form1">
<input type="hidden" name="__VIEWSTATE" value="" />

		</form>
		<form name="f" method="post" action="ProductSearch2.aspx">
		<input type="hidden" name="strP0" value="">
			<div 
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_product.swf?code=D2" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_product.swf?code=D2" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fproduct%2fProductSearch1.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fproduct%2fProductSearch1.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
							...
							<DIV CLASS="CONTENTS">
								...
								<IMG src="http://file.isky.co.kr/images/user/product/search_title.gif" ><BR>
								<!-- step --> &nbsp; <img src="http://file.isky.co.kr/images/product/search_top_s1.gif">
								<BR>
								<IMG height="20" src="/images/com/spacer.gif" width="1"><BR>
								<div style="PADDING-RIGHT:15px;PADDING-LEFT:15px;PADDING-BOTTOM:5px;WIDTH:690px;PADDING-TOP:10px"
									class="BD">
									<img SRC="http://file.isky.co.kr/images/user/product/search_bar_s0.gif"><BR>
								...
								<div class="BD" style="PADDING-RIGHT: 15px; PADDING-LEFT: 15px; PADDING-BOTTOM: 5px; WIDTH: 690px; PADDING-TOP: 10px">
									<img src="http://file.isky.co.kr/images/user/product/search_bar_s1.gif" ><BR>
									<div style="PADDING-RIGHT: 15px; PADDING-LEFT: 15px; PADDING-BOTTOM: 15px; PADDING-TOP: 15px">
										<input name="strP1" value="전체" style="WIDTH: 14px; HEIGHT: 14px" class="no" type="checkbox"
											onclick="All_Select(this.checked);">&nbsp;전체&nbsp;&nbsp; 
										<!--<input name="P1" style="WIDTH: 14px; HEIGHT: 14px" type="checkbox" value="슬라이드" class="no" onclick="jsChkInv()" checked>&nbsp;슬라이드&nbsp;&nbsp;
													<input name="P1" style="WIDTH: 14px; HEIGHT: 14px" type="checkbox" value="싱글" class="no"  onclick="jsChkInv()" checked>&nbsp;싱글폴더&nbsp;&nbsp; 
													<input name="P1" style="WIDTH: 14px; HEIGHT: 14px" type="checkbox" value="듀얼" class="no"  onclick="jsChkInv()" checked>&nbsp;듀얼 폴더&nbsp;&nbsp; 
													<input name="P1" style="WIDTH: 14px; HEIGHT: 14px" type="checkbox" value="플립형" class="no"  onclick="jsChkInv()" checked>&nbsp;플립형&nbsp;&nbsp;-->
										<input name='strP1' style='WIDTH: 14px; HEIGHT: 14px' type='checkbox' value='슬라이드' class='no' onclick='jsChkInv()'>&nbsp;슬라이드&nbsp;&nbsp;<input name='strP1' style='WIDTH: 14px; HEIGHT: 14px' type='checkbox' value='폴더' class='no' onclick='jsChkInv()'>&nbsp;폴더&nbsp;&nbsp;<input name='strP1' style='WIDTH: 14px; HEIGHT: 14px' type='checkbox' value='플립' class='no' onclick='jsChkInv()'>&nbsp;플립&nbsp;&nbsp;
									</div>
								</div>
								<div style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; WIDTH: 690px; PADDING-TOP: 10px"
									align="right">
									<a href="javascript:GoPre();"><IMG SRC="http://file.isky.co.kr/images/user/product/btn_toprev.gif" align="absmiddle"></a>
									<A href="javascript:GoStep2();"><IMG src="http://file.isky.co.kr/images/user/product/btn_tonext.gif" align="absmiddle"></A>
									<a href="javascript:GoResult();"><IMG src="http://file.isky.co.kr/images/com/bbs_button_search.gif" align="absmiddle"></a><BR>
								</div>
								<!--내용들어가는 곳//-->
