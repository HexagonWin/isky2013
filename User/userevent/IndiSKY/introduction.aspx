...
<HTML>
	<HEAD>
		...
		<style>.contline { LINE-HEIGHT: 120% }
		</style>
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="인디그라운드당월공연소개"></Meta_Title>
		<Meta_From value="isky"></Meta_From>
		<Meta_Path value=" 메인:이벤트:인디그라운드:당월공연소개"></Meta_Path>
		<form name="form1" method="post" action="introduction.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMzc3NDg1MzU7Oz4=" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fIndiSKY%2fintroduction.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fIndiSKY%2fintroduction.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
									...
									<DIV CLASS="CONTENTS">
										<DIV class="LINEMAP"><A href="/">Home</A> &gt; <A href="/User/userevent/EventIng.aspx">이벤트</A>
											&gt; <A href="/User/userevent/SkyIndi.aspx">인디그라운드</A> &gt; 당월공연소개</DIV>
										<IMG src="http://file.isky.co.kr/images/indi/indi_title5.gif" vspace="10">
										<DIV CLASS="CONTENTS_SUB">
											<!--이벤트 메인-->
											<table width="682" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td width="518">&nbsp;</td>
													<td width="71"><a href="introduction01.aspx"><img src="http://file.isky.co.kr/images/indi/indi_intro_01.gif" width="66" height="21"
																border="0"></a></td>
													<td width="93"><a href="introduction.aspx"><img src="http://file.isky.co.kr/images/indi/indi_intro_02_on.gif" width="92" height="21"
																border="0"></a></td>
												</tr>
												<tr>
                  ...
                  <table width="668" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="http://file.isky.co.kr/images/indi/indi_intro_01.jpg"><br>
					  <img src="http://file.isky.co.kr/images/indi/indi_intro_02.jpg"><br>
					  <img src="http://file.isky.co.kr/images/indi/indi_intro_03.jpg"><br>
					  <img src="http://file.isky.co.kr/images/indi/indi_intro_04.jpg"><br>
					  <img src="http://file.isky.co.kr/images/indi/indi_intro_05.jpg"><br>
					  <img src="http://file.isky.co.kr/images/indi/indi_intro_06.jpg"></td>
                    </tr>
                  </table>
                  <p>&nbsp;</p>
											<!--이벤트 메인-->
