...
type=TEXT/CSS rel=STYLESHEET>
		...
		//	alert(fm.loginyn.value);
			if(fm.loginyn.value == "True"){
				window.open('','indy','');
			} else {
...
function popup(page,name,x,y){
	opt = "toolbar=no,alwaysRaised=no,location=no,status=no,menubar=no,scrollbars=no,width="+x+",height="+y+",resizable=no, top=0, left=0"
	window.open(page,name,opt)
	}
	
function spopup(page,name,x,y){
	opt = "toolbar=no,alwaysRaised=no,location=no,status=no,menubar=no,scrollbars=yes,width="+x+",height="+y+",resizable=no, top=0, left=0"
	window.open(page,name,opt)
	}
//-->
</SCRIPT>
<script language="javascript">
			...
			function OpenPopup()
			{
			   	...
			   	var sysCookie = getCookie("indinoticePopup");
				if (sysCookie != "no"){
					if(PopupWin != null && !PopupWin.closed) PopupWin.close();
					window.open('indi_notice01.html', 'indinoticePopup', 'width=320, height=520, left=20, top=20, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');
				}
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<Meta_Title value="인디그라운드공연소개"/><Meta_From value="isky"/><Meta_Path value=" 메인:It's different:인디그라운드:공연소개"/>
		<form name="form1" method="post" action="introduction01.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTAzMTQxMDI3Njs7Pg==" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_different.swf?code=J21" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_different.swf?code=J21" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fIndiSKY%2fintroduction01.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fIndiSKY%2fintroduction01.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
									...
									<!--본문내용 들어가는 곳//-->
									<DIV class="CONTENTS">
										<DIV class="LINEMAP"><A href="/">Home</A> &gt; <A href="/User/prroom/cyber.aspx">It's 
												different</A> &gt; <A href="/User/userevent/SkyIndi.aspx">인디그라운드</A> &gt; 
											공연소개</DIV>
										<IMG src="http://file.isky.co.kr/images/indi/indi_title2.gif" 
      >
										<DIV class="CONTENTS_SUB">
											...
											<table cellSpacing="0" cellPadding="0" width="682" border="0">
												<tr>
													<td width="518">&nbsp;</td>
													<td width="71"><A href="introduction01.aspx"><img 
            height=21 src="http://file.isky.co.kr/images/indi/indi_intro_01_on.gif" 
            width=66 border=0></A></td>
													<td width="93"><A href="introduction.aspx"><img 
            height=21 src="http://file.isky.co.kr/images/indi/indi_intro_02.gif" 
  ...
  <tr> 
    <td><img src="http://file.isky.co.kr/images/indi/indi_intro01_01.gif"><br>
      <img src="http://file.isky.co.kr/images/indi/indi_intro01_02.gif"><br>
      <img src="http://file.isky.co.kr/images/indi/indi_intro01_03.gif"></td>
  </tr>
  <input name="loginyn" id="loginyn" type="hidden" value="False" />
</table>
<map name="tiket_Map">
  	<area shape="rect" coords="338,21,461,59" href="http://www.ticketlink.co.kr/ticketlink/OpenTicket/index.jsp" target="_blank">	
	<area shape="rect" coords="206,22,329,60" href="javascript:ticketwin();">
</map>
<map name="Map_01">
  <area shape="rect" coords="544,54,601,74" href="#" onClick="popup('map.html','','350','470')">
  <area shape="rect" coords="499,78,609,106" href="/User/userevent/IndiSKY/introduction.aspx">
</map>
											<!--이벤트 메인--></DIV>
										<!--본문내용 들어가는 곳//-->
										<!--FOOTER-->
