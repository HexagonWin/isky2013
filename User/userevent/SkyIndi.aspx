...
<HTML>
	<HEAD>
		...
		<link title="EVENT" href="http://file.isky.co.kr/css/event.css" type="text/css" rel="stylesheet">
		...
		function OpenPopup(){
			var eventCookie=getCookie("setIndiPopUp");
			if (eventCookie != "no")
			window.open('/User/userevent/IndiSKY/indi_pop.aspx', 'indyPopup', 'width=350, height=380, left=100, top=100, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');
		}
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<Meta_Title value="인디그라운드"></Meta_Title>
		<Meta_From value="isky"></Meta_From>
		<Meta_Path value=" 메인:It's different:인디그라운드"></Meta_Path>
		<form name="form1" method="post" action="SkyIndi.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMjAzMzg3MjkwOzs+" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_different.swf?code=J2" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_different.swf?code=J2" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fSkyIndi.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fSkyIndi.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
									...
									<!--본문내용 들어가는 곳//-->
									<DIV CLASS="CONTENTS">
										<DIV class="LINEMAP"><A href="/" style="gray">Home</A> &gt; <A href="/User/prroom/cyber.aspx" style="gray">
												It's different</A> &gt; 인디그라운드</DIV>
										<IMG src="http://file.isky.co.kr/images/indi/indi_title.gif" width="217" height="67"> 
										<!--이벤트 메인-->
										<table width="690" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="320"><img src="http://file.isky.co.kr/images/indi/indi_01.gif" width="410" height="287"></td>
												<td width="370"><img src="http://file.isky.co.kr/images/indi/indi_02.gif" width="280" height="287"></td>
											</tr>
										</table>
										<table width="690" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="410" valign="top">
													<table width="410" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td rowspan="2"><img src="http://file.isky.co.kr/images/indi/indi_m_01.gif" width="38" height="368"></td>
															<td height="357" width="355" background="http://file.isky.co.kr/images/indi/indi_m_bg.gif" valign="top">
																<table cellspacing="0" cellpadding="0" width="355" height="357">
																	<script language="JavaScript">
												<!--
												var volposition=580; // 볼륨의 최대크기위치
												var volminposition=546; //볼륨의 최소크기 위치
                              ...
                              <td background="http://file.isky.co.kr/images/indi/main_player_top.gif" colspan="3" height="42"><img src="http://file.isky.co.kr/images/indi/m_tit.gif"> 
                              </td>
																		</tr>
																		<tr height="190">
																			<td width="52"><img src="http://file.isky.co.kr/images/indi/main_player_left.gif"></td>
																			<td width="252">
																				<textarea id=skyindiid style="display:none;" rows="0" cols="0">
																				<OBJECT id="SKY_PLAYER" codeBase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701"
																					type="application/x-oleobject" height="190" width="252" classid="clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6"
																					VIEWASTEXT>																					
																					<PARAM NAME="URL" VALUE="http://file.isky.co.kr/indy/indi_sky0603.wmv">
																				...
																				<script language="javascript" src="/embedjs.asp?classid=skyindiid"></script>										
																			</td>
																			<td width="51"><img src="http://file.isky.co.kr/images/indi/main_player_right.gif"></td>
																		</tr>
																		<tr height="37">
																			<td background="http://file.isky.co.kr/images/indi/main_player_middle.gif" colspan="3">
																				<table height="37" cellspacing="0" cellpadding="0" width="355">
																					<tbody>
																						<tr valign="middle">
																							<td width="21"></td>
																							<td width="252"><a onFocus="this.blur();" href="Javascript:PLAYER_PLAY();"><img src="http://file.isky.co.kr/images/indi/main_player_btn_play.gif" align="absMiddle" border="0"></a>
																								<a onFocus="this.blur();" href="Javascript:PLAYER_STOP();"><img src="http://file.isky.co.kr/images/indi/main_player_btn_stop.gif" align="absMiddle" border="0"></a>
																								<a onFocus="this.blur();" href="Javascript:PLAYER_REVERSE();"><img src="http://file.isky.co.kr/images/indi/main_player_btn_tostart.gif" align="absMiddle" border="0"></a>
																								<a onFocus="this.blur();" href="Javascript:PLAYER_FORWARD();"><img src="http://file.isky.co.kr/images/indi/main_player_btn_toend.gif" align="absMiddle" border="0"></a>
																<DIV id="volcontrol" style="MARGIN-TOP: 4px; Z-INDEX: 5; LEFT: 546px; VISIBILITY: visible; POSITION: absolute">
																<IMG onmousedown=initializedragie() style="CURSOR: hand" alt=볼륨조절 src="http://file.isky.co.kr/images/indi/movie_player_vol.gif" name=vol VALIGN="ABSMIDDLE">
																</DIV>															
															</td>
															<td width="57">
															...
															<td width="25"></td>
																		...
																		<tr valign="top">
																			<td background="http://file.isky.co.kr/images/indi/main_player_bottom.gif" colspan="3" height="88">
																				<table width="355" border="0" cellspacing="0" cellpadding="0" height="88">
																					<tr>
																						<td height="36" width="152">&nbsp;</td>
																						<td height="36" width="203"><a href="http://www.microsoft.com/korea/windows/windowsmedia/" target="_blank"><img src="http://file.isky.co.kr/images/indi/main_player_btn_wmp.gif" align="absMiddle" border="0"></a></td>
																					</tr>
																					<tr>
																						<td width="152">&nbsp;</td>
																						<td width="203" style="padding-right:30px;">
																						<marquee id="id1" direction="left" scrollamount="1" scrolldelay="30" width="300" truespeed=true>
																	<font color="#FFFFFF">눈을 돌리면 또다른 세상 / 또다른 즐거움을 볼 수 있다.</font>
																</marquee>
																						</td>
																					</tr>
																				</table>
															...
															<td rowspan="2"><img src="http://file.isky.co.kr/images/indi/indi_m_02.gif" width="17" height="368"></td>
														</tr>
														<tr>
															<td><img src="http://file.isky.co.kr/images/indi/indi_m_03.gif" width="355" height="11"></td>
														</tr>
													</table>
												</td>
												<td width="301" valign="top">
													<table width="248" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td><a href="./IndiSKY/introduction01.aspx"><img src="http://file.isky.co.kr/images/indi/indi_banner01.gif" width="248" height="92" border="0"></a></td>
														</tr>
														<tr>
															<td><a href="/User/userevent/IndiSKY/beforeplay.aspx"><img src="http://file.isky.co.kr/images/indi/indi_banner02.gif" width="248" height="92" border="0"></a></td>
														</tr>
														<tr>
															<td><a href="/User/userevent/IndiSKY/IndiBBSFreeList.aspx"><img src="http://file.isky.co.kr/images/indi/indi_banner03.gif" width="248" height="92" border="0"></a></td>
														</tr>
														<tr>
															<td><a href="/User/userevent/IndiSKY/IndiUserApplMethod.aspx"><img src="http://file.isky.co.kr/images/indi/indi_banner04.gif" width="248" height="92" border="0"></a></td>
														</tr>
													</table>
												</td>
												<td width="33" valign="top"><img src="http://file.isky.co.kr/images/indi/indi_banner_bg.gif" width="32" height="368"></td>
											</tr>
										</table>
										<table width="690" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><img src="http://file.isky.co.kr/images/indi/indi_bg.gif" width="690" height="65"></td>
											</tr>
										</table>
										<!--이벤트 메인-->
										<!--FOOTER-->
