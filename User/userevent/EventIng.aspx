...
-->
		...
		//window.location.href="/User/userevent/EventIng07.aspx";
		</script>
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		...
		<form name="form1" method="post" action="EventIng.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTA0MzkxNDkyMDt0PDtsPGk8MD47PjtsPHQ8O2w8aTw2Pjs+O2w8dDxAU3lzdGVtLkludDMyLCBtc2NvcmxpYiwgVmVyc2lvbj0xLjAuNTAwMC4wLCBDdWx0dXJlPW5ldXRyYWwsIFB1YmxpY0tleVRva2VuPWI3N2E1YzU2MTkzNGUwODk8aTwxPjtpPC0xPjtpPDI+Oz47Oz47Pj47Pj47Pg==" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fEventIng.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fEventIng.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
									...
									<DIV class="CONTENTS">
										...
										<DIV class="CONTENTS_SUB">
											...
											<table width="671" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td align="center"><a href="EventIng06.aspx"><img src="http://file.isky.co.kr/images/event/20060829/20060829_banner01.jpg" border="0"></a><br>
														<a href="EventIng04.aspx"><img src="http://file.isky.co.kr/images/event/20060824/20060824_banner02.jpg" border="0"></a></td>
												</tr>
												<!--tr>
													<td align="center"><img src="http://file.isky.co.kr/images/event/noEvent.gif" border="0">
												</tr-->
											</table>
