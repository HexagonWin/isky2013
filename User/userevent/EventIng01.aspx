...
-->
		...
		function OpenPopup()
		{
			var src='/user/member/MemberInfoEdit1.aspx';
			window.open(src,'eventPopup','width=400, height=400, left=100, top=100, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');
		}
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		...
		<form name="form1" method="post" action="EventIng01.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTIyNjExMzUxNjt0PDtsPGk8MD47PjtsPHQ8O2w8aTw2Pjs+O2w8dDxAU3lzdGVtLkludDMyLCBtc2NvcmxpYiwgVmVyc2lvbj0xLjAuNTAwMC4wLCBDdWx0dXJlPW5ldXRyYWwsIFB1YmxpY0tleVRva2VuPWI3N2E1YzU2MTkzNGUwODk8aTwxPjtpPC0xPjtpPDI+Oz47Oz47Pj47Pj47Pg==" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fEventIng01.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fEventIng01.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<table width="463" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="668" height="150" align="center"><img src="http://file.isky.co.kr/images/event/20060530/20060530_f_01.jpg"></td>
  </tr>
  <tr> 
    <td height="99" align="center"><img src="http://file.isky.co.kr/images/event/20060530/20060530_f_02.jpg"></td>
  </tr>
  <tr> 
    <td height="44" align="center"><img src="http://file.isky.co.kr/images/event/20060530/20060530_f_03.jpg" width="668" height="300" border="0" usemap="#Map"></td>
  </tr>
  <tr> 
    <td height="36" align="center"><img src="http://file.isky.co.kr/images/event/20060530/20060530_f_04.jpg" width="668" height="282" border="0" usemap="#Map2"></td>
  </tr>
</table>
<map name="Map">
  <area shape="circle" coords="602,190,46" href="javascript:EventApply();">
  <area shape="rect" coords="29,169,132,196" href="../member/membernameCheck.aspx">
  <area shape="rect" coords="311,141,375,158" href="../Mypage/MypageMain.aspx?menuCode=A">
</map>
<map name="Map2">
  <area shape="rect" coords="283,240,385,267" href="EventIng02.aspx">
</map>
