...
href="http://file.isky.co.kr/css/event.css" type=text/css rel=stylesheet>
		...
		.conttd { WIDTH: 200px; HEIGHT: 30px; TEXT-ALIGN: left }
		</STYLE>
		...
		function EventApply()
		{
			if(document.all.logintf.value=="F"){
				...
				window.open('/WUC/Login.aspx?wbSUrl=/user/userevent/EventIng04.aspx','login','width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no');
			}
...
//정확한 사이즈
//			var Rtnvalue = showModalDialog(url, window, 'status:false; dialogWidth:646px px; dialogHeight:506px px; help:no; dialogLeft:100pt; dialogTop:100pt; status:no');
//테스트 사이즈
//			var Rtnvalue = showModalDialog(url, window, 'status:false; dialogWidth:646px px; dialogHeight:530px px; help:no; dialogLeft:100pt; dialogTop:100pt; status:no');
//			if (typeof Rtnvalue != "undefined" && Rtnvalue != "")
//			{
//				window.location.href='/user/userevent/Eventing.aspx';
//			}
			var url='/user/userevent/OpenEvent/Event_Modal.aspx';
			window.open(url,'eventPopup','width=900, height=480, left=100, top=100, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		...
		<form name="form1" method="post" action="EventIng04.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwzODM1MjI0MDA7dDw7bDxpPDA+Oz47bDx0PDtsPGk8Nj47PjtsPHQ8QFN5c3RlbS5JbnQzMiwgbXNjb3JsaWIsIFZlcnNpb249MS4wLjUwMDAuMCwgQ3VsdHVyZT1uZXV0cmFsLCBQdWJsaWNLZXlUb2tlbj1iNzdhNWM1NjE5MzRlMDg5PGk8MT47aTwtMT47aTwyPjs+Ozs+Oz4+Oz4+Oz4=" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fEventIng04.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fEventIng04.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<!--table width="671" border="0" cellpadding="0" cellspacing="0">
  <tr> 
                      <td height="350" align="center"><strong>진행 중인 이벤트가 없습니다.</strong></td>
  </tr>
</table-->
                  <table width="671" border="0" cellpadding="0" cellspacing="0">
                    <!--DWLayoutTable-->
                    <tr> 
                      <td align="center"><img src="http://file.isky.co.kr/images/event/20060824/20060824_10.jpg" border="0"></td>
                    </tr>
					
<map name="event_Map">
	<!--area shape="rect" coords="236,1126,430,1168" href="javascript:EventApply();"-->
</map>
                  ...
                  <!--alret popup-->
											...
											<input name="logintf" id="logintf" type="hidden" value="F" /> <input name="subevnid" id="subevnid" type="hidden" value="30" />
