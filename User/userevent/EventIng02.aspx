...
href="http://file.isky.co.kr/css/event.css" type=text/css rel=stylesheet>
		<STYLE TYPE="text/css">
		<!--
td {  font-family: "돋움", "돋움체";  font-size: 9pt; line-height: 22px; color: #666666}
-->
</STYLE>
		<script language="JavaScript">
		<!--
		//alert("진행중인 이벤트가 없습니다.");
		//window.location.href="/User/userevent/EventLast.aspx?menuCode=K3";
		function EventApply()
		{
			if(document.all.logintf.value=="F"){
				//alert("회원 로그인을 하셔야 합니다.");
			}
		...
		function check(thisform,  strcnt)
		{
				
		  if(thisform.value.length > strcnt)
		  {
		    alert(strcnt+'자이내로 작성해주세요');
		    return false;
		  }
		...
		function GoProject1(eventTerm,subEvtID)
		{
			if(eventTerm == "Y")
			{
				...
				if(logtf == "F"){
					alert("회원이시면 먼저 로그인을, 회원이 아니시면 회원가입 후 응모해 주십시오.");
				}
		...
		function Retrieve()
		{
			...
			if(UID.value == '아이디를 입력하세요' || UID.value == '')
			{
				alert('아이디를 입력하세요');
				UID.focus();
				return false;
	...
	*/
		function ticketwin()
		{
			//window.open('./OpenEvent/SkyIndiPopup.aspx','indy','width=630,height=400');
			window.location.href="/User/userevent/IndiSKY/introduction01.aspx?menuCode=K11";
			return;
		}
		...
		function OpenPopup()
		{
			...
			if (eventCookie != "no")
			{
				...
				var src='/defaultPopup.aspx';
				PopupWin = window.open(src,'nPopup','width=320, height=410, left=100, top=100, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');				
			...
			/*		
				...
				if (eventCookie != "no")
				window.open('/User/userevent/IndiSKY/indi_pop.aspx', 'Popup', 'width=350, height=378, left=100, top=100, location=no, resizable=no, scrollbars=no, menubar=no, toolbars=no, directories=no');
			*/
		}
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<Meta_Title value="진행 이벤트 목록" /><Meta_From value="isky" /><Meta_Path value="메인:이벤트:진행이벤트" />
		<form name="form1" method="post" action="EventIng02.aspx" id="form1">
<input type="hidden" name="__VIEWSTATE" value="dDwyMDM1Mjg5NDE7dDw7bDxpPDA+Oz47bDx0PDtsPGk8Nj47PjtsPHQ8QFN5c3RlbS5JbnQzMiwgbXNjb3JsaWIsIFZlcnNpb249MS4wLjUwMDAuMCwgQ3VsdHVyZT1uZXV0cmFsLCBQdWJsaWNLZXlUb2tlbj1iNzdhNWM1NjE5MzRlMDg5PGk8MT47aTwtMT47aTwyPjs+Ozs+Oz4+Oz4+Oz4=" />
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fEventIng02.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fEventIng02.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
									...
									<!--본문내용 들어가는 곳//-->
									<DIV class="CONTENTS">
										<DIV class="LINEMAP"><A href="/">Home</A> &gt; <A href="/User/userevent/EventIng.aspx">이벤트</A>
											&gt; 진행이벤트</DIV>
...
<!--table width="671" border="0" cellpadding="0" cellspacing="0">
  <tr> 
                      <td height="350" align="center" valign="top"><strong>진행중인 이벤트가 없습니다.</strong></td>
  </tr>
</table-->
<table width="671" border="0" cellpadding="0" cellspacing="0">
  <tr> 
                      <td align="center"><img src="http://file.isky.co.kr/images/event/20060626/20060626_01.jpg"><br>
	  <img src="http://file.isky.co.kr/images/event/20060626/20060626_02.jpg"><br>
	  <img src="http://file.isky.co.kr/images/event/20060626/20060626_03.jpg"><br>
	  <img src="http://file.isky.co.kr/images/event/20060626/20060626_04.jpg" width="668" height="313" border="0" usemap="#event03_Map"></td>
  </tr>
<map name="event03_Map">
  <area shape="rect" coords="252,271,416,298" href="EventIng01.aspx">
</map>
<!--map name="event0301_Map">
  <area shape="rect" coords="476,41,608,80" href="http://cafe.naver.com/skymultiplex.cafe" target="_blank">
</map-->
</table>
<!--alret popup-->

											
											<input name="logintf" id="logintf" type="hidden" value="F" /> <input name="subevnid" id="subevnid" type="hidden" value="38" />
