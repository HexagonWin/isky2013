...
-->
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		...
		<form name="form1" method="post" action="EventIng06.aspx" id="form1">
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2fuserevent%2fEventIng06.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2fuserevent%2fEventIng06.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<!--table width="671" border="0" cellpadding="0" cellspacing="0">
  <tr> 
                  ...
                  <table width="671" border="0" cellpadding="0" cellspacing="0">
                    <!--DWLayoutTable-->
                    <tr> 
                      <td height="68" colspan="3" align="center"><img src="http://file.isky.co.kr/images/event/20060714/20060714_01.jpg"><br> 
                        <img src="http://file.isky.co.kr/images/event/20060714/20060714_02.jpg"><br>
						<!--img src="http://file.isky.co.kr/images/event/20060628/20060628_03.jpg" border="0" usemap="#Map"--><img src="http://file.isky.co.kr/images/event/20060714/20060714_03.jpg" border="0"></td>
                    </tr>
                    <map name="Map">
                      <area shape="rect" coords="231,133,438,177" href="../Community/SkyLeader/SkyAppLeader.aspx">
                      <!--area shape="rect" coords="346,127,531,168" href="../Community/SkyLeader/SkyAppLeader.aspx"-->
                    </map>
                  </table>
<!--alret popup-->
