...
<HTML>
	...
	<body leftMargin="0" topMargin="0">
		<Meta_Title value="공지사항 내용"></Meta_Title>
		<Meta_From value="isky"></Meta_From>
		<Meta_Path value=" 메인 : 멤버 : 공지사항  "></Meta_Path>
		<DIV align="left">
			<form name="Form1" method="post" action="noticeRead.aspx" id="Form1">
	...
	<tr>
		<td>
			<OBJECT id="navigation" codeBase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
				...
				<embed src="http://file.isky.co.kr/flash/left/isky_sky_notice.swf?code=UI" width=222 height=475 />
			</OBJECT>
		</td>
	</tr>
	<tr>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2futillity%2fnoticeRead.aspx&amp;wbExt=" width="222" height="138" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
<script>
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2futillity%2fnoticeRead.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
...
<map name="_temp_footer">
	...
	<area SHAPE="rect" COORDS="208,20,248,36" HREF="#" onfocus="this.blur()">
								...
								<DIV CLASS="CONTENTS">
									<!--본문내용 들어가는 곳//-->
									<DIV class="LINEMAP"><a href='/'>Home</a> &gt; 공지사항
									</DIV>
									<IMG 
      src="http://file.isky.co.kr/images/user/utility/notice_title.gif"><BR>
									...
									<DIV ID="CONTENTS_SUB" STYLE="PADDING-TOP:25px">
										...
										<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
											...
											<TR HEIGHT="28" STYLE="PADDING-TOP:4px">
												...
												<TD WIDTH="171" CLASS="BBS_READ_TAB">
													<span id="lblListNo"></span></TD>
											...
											<TR HEIGHT="28" STYLE="PADDING-TOP:4px">
												...
												<TD CLASS="BBS_READ_TAB" COLSPAN="5">
													<DIV id="divAttList" style="DISPLAY: inline"></DIV>
												</TD>
											</TR>
											<TR>
												<TD COLSPAN="6" BGCOLOR="#e7d2d2"></TD>
										...
										<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" STYLE="MARGIN-BOTTOM:7px">
											<TR>
												<TD ALIGN="right" HEIGHT="43" STYLE="PADDING-TOP:6px">
													<A HREF="noticeList.aspx?pPageNo=1"><IMG SRC="http://file.isky.co.kr/images/com/bbs_button_list.gif"></A>
												</TD>
											</TR>
											<TR>
