...
<HTML>
	<HEAD>
		...
		<meta http-equiv="Expires" content="Thu, 4 Jul 1973 19:15:00 -0000">
	...
	<body>
		<Meta_Title Value="사이트맵" />
		<Meta_From Value="isky" />
		<Meta_Path Value="Home:사이트맵" />
		<form name="member" method="post" action="siteMap.aspx" id="member">
<input type="hidden" name="__VIEWSTATE" value="dDwtMTI4MTk0MDYyNDs7Pg==" />
	...
	<tr>
		<td>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" height="512" width="222" VIEWASTEXT>
			  <param name="movie" value="http://file.isky.co.kr/flash/left/isky_sky_sitemap.swf?code=UF" />
			  <param name="quality" value="high" />
			  <embed src="http://file.isky.co.kr/flash/left/isky_sky_sitemap.swf?code=UF" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="512" width="222"></embed>
			</object>
			</textarea>
...
<iframe name="leftlogin" src="/WUC/leftLogin.aspx?wbSurl=%2fUser%2futillity%2fsiteMap.aspx&amp;wbExt=" width="222" height="110" border="0" NORESIZE SCROLLING=no FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0>
</iframe>
...
*/
	...
	function loginurl()
	{
		window.open("/WUC/Login.aspx?wbExt=&wbSurl=%2fUser%2futillity%2fsiteMap.aspx","login","width=500,height=220,top=10,left=10,toolbar=0,menubar=0,scrollbars=no,resizable=no");
	}
</script>
</td>
							...
							<table cellSpacing="0" cellPadding="0" width="728" border="0">
								<tr>
									<td>
										<DIV class="CONTENTS">
											<!--내용들어가는 곳//-->
											<DIV class="LINEMAP"><a href="/">Home</a> &gt;&nbsp;SiteMap</DIV>
											<IMG SRC="http://file.isky.co.kr/images/utility/sitemap_title.gif"><BR>
                  
                  <img src="http://file.isky.co.kr/images/utility/sitemap_img01.gif" border="0" usemap="#map1"><br>
                  <IMG SRC="http://file.isky.co.kr/images/utility/sitemap_img02.gif" border="0" usemap="#map2"><br>
                  <map name="map1">
                    <!-- 제품정보 -->
                    <area alt="" coords="43,50,85,65" href="javascript:goURL('D00')" shape="RECT">
                    <area alt="" coords="43,68,85,83" href="javascript:goURL('D2')" shape="RECT">
                    <area alt="" coords="43,86,85,102" href="javascript:goURL('D3')" shape="RECT">
                    <area alt="" coords="43,104,85,120" href="javascript:goURL('D4')" shape="RECT">
                    <area alt="" coords="43,122,85,138" href="javascript:goURL('D5')" shape="RECT">
                    <!-- 커뮤니티 -->
                    <area alt="" coords="147,163,187,178" href="javascript:goURL('B11')" shape="RECT">
                    <area alt="" coords="147,180,187,196" href="javascript:goURL('B21')" shape="RECT">
                    <area alt="" coords="147,199,187,214" href="javascript:goURL('B31')" shape="RECT">
                    <area alt="" coords="147,216,187,232" href="javascript:goURL('B41')" shape="RECT">
                    <!--area alt="" coords="173,149,208,161" href="javascript:goURL('B51')" shape="RECT"-->
                    <!-- 모바일컨텐츠 -->
                    <area shape="rect" coords="257,58,289,74" href="javascript:goURL('C1')">
                    <area shape="rect" coords="257,76,307,92" href="javascript:goURL('C2')">
                    <area shape="rect" coords="257,93,289,110" href="javascript:goURL('C3')">
                    <area shape="rect" coords="257,112,281,128" href="javascript:goURL('C43')">
                    <area shape="rect" coords="257,130,281,147" href="javascript:goURL('C5')">
                    <!-- 고객지원 -->
                    <area alt="" coords="361,172,401,186" href="javascript:goURL('E1')" shape="RECT">
                    <area alt="" coords="361,190,401,205" href="javascript:goURL('E2')" shape="RECT">
                    <area alt="" coords="361,207,401,222" href="javascript:goURL('E3')" shape="RECT">
                    <area alt="" coords="361,226,430,241" href="javascript:goURL('E36')" shape="RECT">
                    <area alt="" coords="361,244,412,259" href="javascript:goURL('E4')" shape="RECT">
                    <area alt="" coords="361,261,409,276" href="javascript:goURL('E5')" shape="RECT">
                    <!-- 이벤트 -->
                    <area alt="" coords="449,50,501,66" href="javascript:goURL('K1')" shape="RECT">
                    <area alt="" coords="449,68,501,84" href="javascript:goURL('K2')" shape="RECT">
                    <area alt="" coords="449,86,507,103" href="javascript:goURL('K5')" shape="RECT">
					<!--<area alt="" coords="449,104,506,121" href="javascript:goURL('K6')" shape="RECT">-->
                    <!-- It's different -->
					<area alt="" coords="580,71,639,88" href="javascript:goURL('J1')" shape="RECT">
					<area alt="" coords="580,89,639,106" href="javascript:goURL('J2')" shape="RECT">
					<area alt="" coords="580,107,639,123" href="javascript:goURL('J4')" shape="RECT">
                    <!--area alt="" coords="580,124,639,141" href="javascript:goURL('J4')" shape="RECT"-->
                  </map>
				  <map name="map2">
                    <!--고객지원-->
                    <area alt="" coords="361,3,401,19" href="javascript:goURL('E6')" shape="RECT">
                    <!-- 마이페이지 -->
                    <area alt="" shape="rect" coords="78,30,118,46" href="javascript:goURL('A1')">
												<area alt="" shape="rect" coords="78,48,135,64" href="javascript:goURL('A2')">
												<area alt="" shape="rect" coords="78,66,119,83" href="javascript:goURL('AA')">
												<area alt="" shape="rect" coords="78,84,137,100" href="javascript:goURL('A31')">
												<area alt="" shape="rect" coords="78,102,119,118" href="javascript:goURL('A41')">
												<area alt="" shape="rect" coords="78,120,119,136" href="javascript:goURL('A71')">
												<area alt="" shape="rect" coords="78,138,119,154" href="javascript:goURL('A72')">
												<area alt="" shape="rect" coords="78,156,156,173" href="javascript:goURL('A73')">
												<area alt="" shape="rect" coords="78,174,156,191" href="javascript:goURL('A74')">
												<!-- 회원가입 -->
												<area alt="" coords="224,105,283,122" href="javascript:goURL('U1')" shape="RECT">
												<area alt="" coords="224,124,265,140" href="javascript:goURL('U2')" shape="RECT">
												<area alt="" coords="224,142,283,158" href="javascript:goURL('U3')" shape="RECT">
												<area alt="" coords="224,159,265,177" href="javascript:goURL('U4')" shape="RECT">
												<!-- 글로벌메뉴 -->
												<area alt="" coords="347,80,434,101" href="javascript:goURL('UL')" shape="RECT">
												<area alt="" coords="347,107,393,127" href="javascript:goURL('UI')" shape="RECT">
												<area alt="" coords="347,134,393,154" href="javascript:goURL('UM')" shape="RECT">
												<area alt="" coords="347,160,402,179" href="javascript:goURL('UG')" shape="RECT">
											</map>
